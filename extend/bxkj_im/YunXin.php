...
class YunXin
{
    ...
    public function sendBatchAttachMsg($fromAccid, $toAccids, $attach, $pushcontent = '', $payload = array(), $sound = '')
    {
	 ...
	 * @return $result      [返回array数组对象]
	 */
	public function createGroup($tname, $owner, $members, $announcement = '', $intro = '', $msg = '', $magree = '0', $joinmode = '0', $custom = '', $icon = "")
	{
