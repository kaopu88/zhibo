...
class WxpayWxwapPayMethod extends WxpayPayMethod
{
    protected $payMethod = 'wxpay_wxwap';
    ...
    public function unifiedorder($inputData, $tradeData)
    {
        ...
        $wxpayInfo['mweb_url'] = $result['mweb_url'] . '&redirect_url='. urlencode(DOMAIN_URL .'/h5/recharge/index?pay_method=wxwap&rel_no='.$tradeData['rel_no']);
