        ...
        <form action="{:isset($_info['id'])?url('edit'):url('add')}">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="uid" value="{$_info.uid}" readonly/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">评论对应消息id</td>
                    <td>
                        <input class="base_text" name="fcmid" value="{$_info.fcmid}" readonly/>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="field_name">图片链接</td>
                    <td>
                        <input class="base_text" name="imgs" value="{$_info.imgs|default=''}"/>
                    </td>
                </tr>
                <tr>
