...
<block name="body">
    <div class="pa_20">
        ...
        <form action="{:isset($_info['id'])?url('editexpress'):url('addexpress')}">
            <table class="content_info2 mt_10">
                <tr>
                    <td class="field_name">词条类型</td>
                    <td>
                        <select class="base_select" name="classid" selectedval="{$_info.classid}">
                            <option value="">请选择</option>
                            <volist name="_flclassfiy" id="classid">
                                <option value="{$classid.value}">{$classid.name}</option>
                            </volist>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="field_name">来源</td>
                    <td>
                        <input class="base_text" name="from" value="{$_info.from|default=0}"/>
                    </td>
                </tr>

                <tr>
                    <td class="field_name">内容文字</td>
                    <td>
