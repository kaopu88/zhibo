...
<block name="body">
    <div class="pa_20">
        ...
        <form action="{:isset($_info['topic_id'])?url('edit'):url('add')}">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    <td class="field_name">话题名称</td>
                    <td>
                        <input class="base_text" name="topic_name" value="{$_info.topic_name}"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <present name="_info['topic_id']">
                            <input name="id" type="hidden" value="{$_info.topic_id}"/>
                        </present>
                        __BOUNCE__
