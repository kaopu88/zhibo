    ...
    <div class="pa_20">
        ...
        <form action="{:isset($_info['id'])?url('edit'):url('add')}">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    <td class="field_name">评论对应消息id</td>
                    <td>
                        <input class="base_text" name="fcmid" value="{$_info.fcmid}" {:isset($_info['id'])?'readonly':''}/>
                    </td>
                </tr>

                <tr>
                    <td class="field_name">评论内容</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input name="images" type="hidden" value="{$_info.imgs}"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">回复量</td>
                    <td>
                        <input class="base_text" name="evaluate_count" value="{$_info.evaluate_count|default=0}"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">点赞量</td>
                    <td>
                        <input class="base_text" name="like_count" value="{$_info.like_count|default=0}"/>
                    </td>
                </tr>
                <tr>
