            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        <input placeholder="作者名称" type="text" name="keyword" value="{:input('keyword')}"/>
            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>
                            <div tgradio-not="{:check_auth('friend:author:change_status')?'0':'1'}" tgradio-on="1"
                                 tgradio-off="0" tgradio-value="{$vo.status}"
                                 tgradio-name="status" tgradio-on-name="启用" tgradio-off-name="关闭"
                                 tgradio="{:url('author/change_status',['id'=>$vo['id']])}"></div>
                        </td>
                        <td>
