            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        <input placeholder="标题或作者" type="text" name="keyword" value="{:input('keyword')}"/>
                ...
                <notempty name="_list">
                    <volist name="_list" id="vo">
                        ...
                        <tr data-id="{$vo.id}">
                            ...
                            <td>
                                    {$vo.classfiy|short='20'}
                            </td>
                            <td>
                                <notempty name="vo['lyricsarray']">
                                    {$vo['lyricsarray'][0]|short='20'}
                                </notempty>
                            </td>
                            ...
                            <td>
                                <div tgradio-not="{:check_auth('friend:Lyrics:change_hot')?'0':'1'}" tgradio-on="1"
                                     tgradio-off="0" tgradio-value="{$vo.is_hot}"
                                     tgradio-name="ishot" tgradio-on-name="热搜" tgradio-off-name="普通"
                                     tgradio="{:url('Lyrics/change_hot',['id'=>$vo['id']])}"></div>
                            </td>
                            ...
                            <td>
                                <div tgradio-not="{:check_auth('friend:Lyrics:change_status')?'0':'1'}" tgradio-on="1"
                                    ...
                                    tgradio="{:url('Lyrics/change_status',['id'=>$vo['id']])}"></div>
                            </td>
                            <td>
