...
<div class="main">
            ...
            <div class="flex">
                <div class="main_top_logo">
                    <a href="javascript:;" style="text-decoration: none;">
                        <!-- <img alt="{:config('site.company_name')}" title="{:config('site.company_name')}" style="width: 210px;height: 61px;" src="__ADMIN__/images/logo.jpg"/>-->
                        <div style="background-color: #f9f9f9;width: 180px;height: 50px;line-height: 20px;text-align: left;color: #444;font-size: 14px;font-weight: bold;padding-top: 10px;padding-left: 20px;padding-right: 10px;">
                            <div style="overflow: hidden;word-break: keep-all;font-size:22px;">
                                ...
                                <span style="font-size: 12px;font-weight: normal;color: #777">{:config('app.agent_setting.promoter_name')}管理平台</span>
                            </div>
                        </div>
                    </a>
                </div>
    ...
    <div class="main_top_content">
        ...
        <div class="main_top_bar">
            <ul class="nav_list">
                <volist name="promoter_tree[0]['children']" id="menu1">
    ...
    <div class="main_left">
        ...
        <div class="sidebar_box">
            <ul class="sidebar">
                <volist name="promoter_tree[1]['children']" id="menu2">
