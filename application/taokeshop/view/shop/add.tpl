        ...
        <form action="{:isset($_info['id'])?url('edit'):url('add')}">
            <table class="content_info2 mt_10">
                        ...
                        <div class="modal_select modal_select_s">
                            ...
                            <ul class="modal_select_list">
                                ...
                                <volist name="cate_list" id="cate">
                                    <li class="modal_select_option" value="{$cate_list.id}">{$cate_list.name}</li>
                                </volist>
                            </ul>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            ...
                            <a uploader-type="image" href="javascript:;" class="base_button" uploader="taoke_images" uploader-field="img">上传</a>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="status" selectedval="{$_info.has_coupon}">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="status" selectedval="{$_info.is_top}">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="status" selectedval="{$_info.is_new}">
                            <option value="1">是</option>
                            <option value="0">否</option>
                        </select>
                    </td>
