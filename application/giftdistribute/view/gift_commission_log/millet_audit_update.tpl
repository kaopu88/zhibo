...
<div title="提现编辑" class="layer_box millet_audit_update pa_10" dom-key="millet_audit_update"
     popbox-action="{:url('giftdistribute/gift_commission_log/change_status')}" popbox-get-data="{:url('giftdistribute/gift_commission_log/change_status')}" popbox-area="700px,550px">
