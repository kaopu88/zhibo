        ...
        <div class="filter_box mt_10">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="base_button base_button_s reg_btn">注册新用户</div>
                    <eq name="agent.add_sec" value="1">
                        <div data-listids="1" data-transfer="user"
                             class="base_button base_button_s transfer_btn">批量分配{:config('app.agent_setting.agent_name')}
                        </div>
                    </eq>
                    ...
                    <volist name="_list" id="vo">
                        <tr data-id="{$vo.user_id}">
                            ...
                            <td>
                                ...
                                <a class="transfer_btn" data-transfer="user" data-id="{$vo.user_id}" data-transferway="promoter" data-
                                href="javascript:;">分配{:config('app.agent_setting.promoter_name')}</a><br/>
