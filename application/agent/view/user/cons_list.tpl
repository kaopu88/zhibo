                    ...
                    <td>
                        <switch name="vo['rel_type']">
                            <case value="live_gift">
                                ...
                                赠送{$vo.rel_info.name}，消费{$vo.rel_info.price}{:config('app.product_info.bean_name')}
                            </case>
                            ...
                            <case value="barrage">
                                {$vo.rel_info.order_no}<br/>
                                发送{$vo.rel_info.name}，消费{$vo.rel_info.price}{:config('app.product_info.bean_name')}
                            </case>
                            <case value="loss">
                                {$vo.rel_info.order_no}<br/>
                                用户超过{$vo.rel_info.name},已清算{$vo.rel_info.price}{:config('app.product_info.bean_name')}
                            </case>
                            <case value="props">
                                {$vo.rel_info.order_no}<br/>
                                发送{$vo.rel_info.name}，消费{$vo.rel_info.price}{:config('app.product_info.bean_name')}
                            ...
                            <case value="liudanji">
                                {$vo.rel_info.order_no}<br/>
                                {$vo.rel_info.name}，消费{$vo.rel_info.price}{:config('app.product_info.bean_name')}
                            </case>
