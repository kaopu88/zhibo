...
<block name="js">
    ...
    <script>
        var userId = '{$anchor.user_id}';
    </script>
    <script src="__JS__/anchor/detail.js?v=__RV__"></script>
</block>
    ...
    <div class="pa_20">
        ...
        <div class="user_base">
            ...
            <div class="user_base_info">
                ...
                <p>
                    ...
                    &nbsp;&nbsp;加入主播时间：{$anchor.create_time|time_format='','date'}
                </p>
            </div>
        ...
        <table class="content_list mt_10 show_num">
            <tr>
                <td>
                   ...
                   <!-- <span class="show_num_span">{$anchor.total_millet}</span>-->
                </td>
                <td>
                    今日活跃人数
                    <br/>
                    <span class="show_num_span">{$day_active}</span>
                </td>
                <td>
                    本月活跃人数
                    <br/>
                    <span class="show_num_span">{$month_active}</span>
                </td>
                <td>
                    总直播时长
                    <br/>
                    <span class="show_num_span">{$anchor.total_duration|time_str='i'}</span>
                </td>
            </tr>
        </table>

        <div class="data_block mt_10 millet_trend">
            <div class="data_title">获得{:APP_MILLET_NAME}趋势图</div>
        ...
        <div class="content_title2">
            ...
            <div class="content_links">
                <a target="_blank" href="{:url('kpi_millet/index',['anchor_uid'=>$anchor.user_id])}">更多记录({$millet_total})</a>
            </div>
        </div>
        <div class="mt_10">
