            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        ...
                        <input placeholder="经纪人ID" type="text" name="promoter_uid" value="{:input('promoter_uid')}"/>
                ...
                <notempty name="_list">
                    <volist name="_list" id="vo">
                        <tr data-id="{$vo.id}">
                            ...
                            <td>{$vo.id}</td>
                            <td>
                                <!--<include link="{:url('anchor/detail',['user_id'=>$vo.promoter_uid])}" file="user/user_info"/>-->
                                <div class="thumb">
                                    <a href="{:url('user/detail',['user_id'=>$vo.promoter_uid])}"
                                    class="thumb_img thumb_img_avatar">
                                        <img src="{$vo.promoter_avatar}"/>
                                    </a>
                                    <p class="thumb_info">
                                        <a href="{:url('user/detail',['user_id'=>$vo.promoter_uid])}">
                                            <if condition="$vo['promoter_uid']">
                                                [{$vo.promoter_uid}]<br/>
                                                {$vo.promoter_nickname|user_name}
                                                <else/>
                                                无
                                            </if>
                                        </a>
                            ...
                            <td>{$vo.remark}</td>
                            <td>
                                <notempty name="vo.pics">
                                    <volist name="vo.pic_list" id="v">
                                        <a title="" rel="common" href="{$v}" class="thumb_img fancybox">
                                            <img src="{$v}" style="width: 50px;height: 50px;border: 1px solid #999;">
                                        </a>
                                    </volist>
                                </notempty>
                            </td>
                            ...
                            <td>
                                <eq name="vo.status" value="0">
                                    <a  <if condition="$vo['user_verified'] neq 1">href="javascript:;"  class="fc_gray" <else/>  ajax="get" ajax-confirm="是否通过该申请？"   class="fc_red"   href="{:url('review',['id'=>$vo.id,'status'=>1])}"</if>>审核</a>
