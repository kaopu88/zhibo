                        ...
                        <volist name="_list" id="vo">
                            <tr data-id="{$vo.id}">
                                ...
                                <td>
                                    ...
                                    <if condition="$vo.status !== '0' || !empty($vo.handle_desc)">
                                ...
                                <td>
                                    <switch name="vo['status']">
                                        <case value="0">
                                            <auth rules="admin:user_verified:audit">
                                                <a data-id="id:{$vo.id}" poplink="verified_handler"
                                                   href="javascript:;">处理</a><br/>
                                            </auth>
                                            <a data-query="id={$vo.id}&type=user_verified" poplink="task_transfer_box"
...
<block name="layer">
    <include file="user_verified/handler"/>
