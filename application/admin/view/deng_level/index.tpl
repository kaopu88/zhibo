...
<block name="js">
    ...
    <script src="__JS__/anchor_exp_level/index.js?v=__RV__"></script>
</block>
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div style="float: left">
                        <auth rules="admin:anchor_exp_level:add">
                            <a href="{:url('add')}?__JUMP__" class="base_button base_button_s">新增</a>
                        </auth>
                        <auth rules="admin:anchor_exp_level:delete">
            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.levelid}">
                        ...
                        <td>
                            <auth rules="admin:anchor_exp_level:update">
