            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>{$vo.content}</td>
                        <td>
                            <auth rules="admin:sms_template:update">
