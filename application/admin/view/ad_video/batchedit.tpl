...
<block name="body">
        ...
        <div class="panel mt_10 each_panel" id="each_panel_{$vo.videoid}" data-video="{$vo.videoid}">
            ...
            <div class="panel-body">
                <table class="content_info2 mt_10">
                    ...
                    <tr>
                        <td class="field_name">广告类型</td>
                        <td>

                            <select class="base_select" name="is_ad">
                                <option value="1" >APP下载广告</option>
                                <option value="2" >网页广告</option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="base_text" name="ad_url" value="{$vo.ad_url}"/>
                        </td>
                    </tr>
    ...
    <script>
        ...
        function ListItem($selector){
            $selector.find('.open_map').click(function () {
                ...
                myLocation.open(params, function (lnglat) {
                    ...
                    $s.post("{:url('video/findCity')}",{city:lnglat.city},function (res) {
                        if(res.status==0){
                            if (videoId) {
        ...
        $('.submit').click(function(){
            ...
            var is_ad = $('.base_select option:selected').val();
