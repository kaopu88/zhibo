            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>
                            <div class="thumb">
                                <a layer-title="0" layer-area="414px,779px" layer-open="{:url('video/tcplayer',['id'=>$vo.id, "type"=>"teenager"])}"
                                   href="javascript:;" class="thumb_img" style="display: inline-block;max-width: 100px;">
                                    <img src="{:img_url($vo['cover_url']?$vo['cover_url']:$vo['cover_url'],'200_200','thumb')}"/>
                                </a>
                            </div>
                        </td>
                        <td>{$vo.title}</td>
                        ...
                        <td>{$vo.sort}</td>
                        <td>
                            <div tgradio-not="{:check_auth('taoke:video_teenager:update')?'0':'1'}" tgradio-on="1" tgradio-off="0"
                        ...
                        <td>
                            <auth rules="taoke:video_teenager:update">
                                <a href="{:url('edit',array('id'=>$vo['id']))}?__JUMP__">编辑</a> |
                            </auth>
                            <auth rules="taoke:video_teenager:delete">
