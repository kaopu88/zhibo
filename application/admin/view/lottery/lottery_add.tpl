        ...
        <form action="{:isset($_info['id'])?url('lottery_edit'):url('lottery_add')}">
            ...
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <textarea style="width:900px;height:100px;" name="rules" ueditor>{$_info.rules}</textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea style="width:900px;height:100px;" name="description" ueditor>{$_info.description}</textarea>
                    </td>
                </tr>
