        ...
        <form action="{:isset($_info['id'])?url('edit'):url('add')}">
            ...
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input placeholder="" suggest-value="[name=gift_id]" suggest="{:url('gift/get_suggests')}"
                            ...
                            <a fill-value="[name=gift_id]" fill-name=".gift" layer-open="{:url('gift/find')}"
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="desc" class="base_text" style="height:120px;"></textarea>
                    </td>
                </tr>
