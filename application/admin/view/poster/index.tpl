            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div style="float: left">
                        ...
                        <auth rules="admin:poster:edit">
                            <a href="{:url('clear')}" ajax="post" ajax-target="list_id" ajax-confirm class="base_button base_button_s base_button_red">清除海报</a>
                        </auth>
                    </div>
            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>
                            <div class="thumb">
                                <a rel="thumb" href="{:img_url($vo['bg_url'],'','thumb')}" class="thumb thumb_img user_base_avatar fancybox" alt="">
                                    <img src="{:img_url($vo['bg_url'],'200_200','cover')}"/>
                                </a>
                            </div>
                        </td>
                        <td>
                            <div tgradio-not="{:check_auth('admin:poster:edit')?'0':'1'}" tgradio-on="1"
                                 tgradio-off="0" tgradio-value="{$vo.status}"
                                 tgradio-name="status"
                                 tgradio="{:url('poster/change_status',['id'=>$vo['id']])}"></div>
                        </td>
                        <td>
