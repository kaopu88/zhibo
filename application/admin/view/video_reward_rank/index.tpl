    ...
    <div class="pa_20">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        ...
                        <input placeholder="打赏人用户ID" type="text" name="user_id" value="{:input('user_id')}"/>
                        <input placeholder="打赏对象用户ID" type="text" name="to_uid" value="{:input('to_uid')}"/>
        ...
        <table class="content_list mt_10">
            ...
            <tr>
                ...
                <td style="width: 5%;">礼物价格</td>
                <td style="width: 15%;">视频信息</td>
                <td style="width: 15%;">打赏人信息</td>
                <td style="width: 15%;">打赏对象信息</td>
                <td style="width: 10%;">打赏留言</td>
                <td style="width: 15%;">打赏时间</td>
            </tr>
            </thead>
            <tbody>
            <notempty name="_list">
