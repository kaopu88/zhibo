                    ...
                    <table class="content_info2">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <notempty name="_info['id']">
                                    <div class="mt_10">
                                        <div class="base_button base_button_s base_button_gray save_remark">保存备注</div>
                                    </div>
                                </notempty>
                            </td>
                        </tr>
            ...
            <div class="panel mt_10">
                ...
                <div class="panel-body">
                    <table class="content_info2">
                        ...
                        <tr style="<if condition="$_info['id']=='' "> display:none;  </if>">
                            <td class="field_name">修改主账号密码</td>
                            <td>
                                <input type="password"  class="base_text" name="password" value=""/>
                                <p class="field_tip">为空则不修改</p>
                            </td>
                        </tr>
