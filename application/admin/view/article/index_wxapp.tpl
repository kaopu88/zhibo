        ...
        <div class="content_toolbar mt_10">
            <ul class="content_toolbar_btns">
                <auth rules="admin:article:add">
                    <li><a href="{:url('add',['pcat_id'=>$pcat_id,'cat_id'=>input('cat_id')])}?__JUMP__"
                ...
                <div class="base_group">
                    ...
                    <div class="modal_select modal_select_s">
                        ...
                        <input name="cat_id" type="hidden" class="modal_select_value finder"
                               value="{:input('cat_id')}"/>
                        <ul class="modal_select_list">
                            <li class="modal_select_option" value="">全部类目</li>
            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>
                            <div tgradio-not="{:check_auth('admin:article:update')?'0':'1'}" tgradio-on="1" tgradio-off="0" tgradio-value="{$vo.status}" tgradio-name="status" tgradio="{:url('change_status',array('id'=>$vo['id']))}"></div>
                        </td>
                        <td>
