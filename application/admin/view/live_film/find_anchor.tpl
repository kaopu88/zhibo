            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.user_id}" class="find_list_li">
                        ...
                        <td>
                            <eq name="vo['available_status']" value="1">
                                <span class="fc_green">未占用</span>
                                <else/>
                                <span class="fc_red">
                                    已占用<br/>
                                     {$vo.conflict_start_time|time_format='','m-d H:i:s'}<br/>
                                     {$vo.conflict_end_time|time_format='','m-d H:i:s'}
                                </span>
                            </eq>
                        </td>
