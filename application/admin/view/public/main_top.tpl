    ...
    <div class="main_nav">
        <div class="flex_between">
            ...
            <ul class="tool_list">
                ...
                <li><a title="退出" ajax-confirm="是否确认退出？" confirm ajax="get" href="{:url('account/logout')}"><span
                ...
                <li class="avatar_link">
                    ...
                    <ul class="avatar_list">
                        <li><a href="{:url('personal/base_info')}">{$admin|user_name}</a></li>
                        <li><a href="{:url('personal/change_pwd')}">修改密码</a></li>
