    ...
    <div class="pa_20">
        ...
        <div class="user_base">
            ...
            <div class="user_base_info">
                ...
                <p>
                    <span class="icon-phone"></span>&nbsp;{$user.phone|str_hide=3,4|default='未绑定'}
        ...
        <div class="content_title2">
            ...
            <div class="content_links">
                <auth rules="admin:anchor:guard">
                    <a href="javascript:;" data-query="anchor_uid={$user.user_id}" poplink="add_anchor_guard"><span style="margin-right: 10px;" class="icon-plus"></span>守护</a>
                </auth>
            </div>
        </div>
        <div class="table_slide">
        ...
        <div class="content_title2">
            TA的场控&nbsp;({$manager_total})
            <div class="content_links">
                <auth rules="admin:anchor:live_manage">
                    <a href="javascript:;" data-query="anchor_uid={$user.user_id}" poplink="add_live_manage"><span style="margin-right: 10px;" class="icon-plus"></span>场控</a>
                </auth>
            </div>
        </div>
        <div class="table_slide">
                        ...
                        <tr data-id="{$vo.user_id}">
                            ...
                            <td>
                                <auth rules="admin:anchor:live_manage">
                                    ...
                                    href="{:url('anchor/remove_live_manage',['anchor_uid'=>$user['user_id'],'user_id'=>$vo.user_id])}">移除场控</a>
                                </auth>
                            </td>
                        </tr>
                    </volist>
        ...
        <div class="content_title2">
            粉丝贡献榜
            <div class="content_links">
                <auth rules="admin:anchor:contr">
                    <a href="{:url('rank/contr',['interval'=>'his','user_id'=>$user['user_id']])}"><span style="margin-right: 10px;" class="icon-plus"></span>全部</a>
                </auth>
            </div>
        </div>
        <div class="table_slide">
            <table class="content_list mt_10 md_width">
                ...
                <notempty name="heroes_rank">
                    <volist name="heroes_rank" id="vo">
                      ...
                      <!--      <td>
                                <a data-query="user_id={$vo.user_id}&interval=his&millet={$vo.real_millet}&name=contr:real:{:input('user_id')}" poplink="millet_handler"
                                href="javascript:;">真实{:APP_MILLET_NAME}变更</a><br/>
                                <a data-query="user_id={$vo.user_id}&interval=his&millet={$vo.virtual_millet}&name=contr:isvirtual:{:input('user_id')}" poplink="millet_handler"
...
<block name="layer">
    ...
    <include file="anchor/add_anchor_guard"/>
    <include file="anchor/add_live_manage"/>
</block>