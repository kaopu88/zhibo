...
<block name="body">
    <div class="pa_20 p_nav">
        ...
        <div class="table_slide">
            ...
            <tbody>
            <notempty name="charm_rank">
                <volist name="charm_rank" id="vo">
                    <tr data-id="{$vo.user_id}">
                        ...
                        <td>{$vo.millet}</td>
                        <td>
                            <a data-query="user_id={$vo.user_id}&interval={:input('interval')}&millet={$vo.millet}&name=charm<if condition="$get.rnum != ''">&rnum={$get.rnum}</if>" poplink="millet_handler"
