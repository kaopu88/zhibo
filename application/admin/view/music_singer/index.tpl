                ...
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>
                            ...
                            歌曲数量：<a href="{:url('music/index',array('singer_id'=>$vo['id']))}">{$vo.songs_total}</a><br/>
                            mv数量：<a href="javascript:;">{$vo.mv_total}</a><br/>
                            专辑数量：<a href="{:url('music_album/index',array('singer_id'=>$vo['id']))}">{$vo.albums_total}</a>
                        </td>
                        <td>
                            {$vo.create_time|time_format='无','date'}
                        </td>
                        <td>
                            <auth rules="admin:music_singer:update">
