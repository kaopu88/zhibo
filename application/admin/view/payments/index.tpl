            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div style="float: left">
                        <auth rules="admin:payments:add">
                            <a href="{:url('add')}?__JUMP__" class="base_button base_button_s">新增</a>
                        </auth>
                        <auth rules="admin:payments:delete">
            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>{$vo.list_order}</td>
                        <td>
                            <div tgradio-not="{:check_auth('admin:payments:update')?'0':'1'}" tgradio-on="1"
                                 tgradio-off="0" tgradio-value="{$vo.status}"
                                 tgradio-name="status"
                                 tgradio="{:url('payments/change_status',['id'=>$vo['id']])}"></div>
                        </td>
                        <td>
                            {$vo.addtime|time_format='无','date'}
                        </td>
                        <td>
                            <auth rules="admin:payments:update">
