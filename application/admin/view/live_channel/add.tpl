        ...
        <form action="{:isset($_info['id'])?url('edit'):url('add')}">
            <table class="content_info2 mt_10">
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="parent_id" selectedval="{$_info.parent_id}">
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="description" class="base_textarea">{$_info.description}</textarea>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">排序</td>
                    <td>
                        <input class="base_text" name="sort_order" value="{$_info.sort_order}"/>
                    </td>
                </tr>
                <tr>
