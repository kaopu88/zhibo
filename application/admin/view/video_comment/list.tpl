...
<block name="body">
    <div class="pa_20">
        <div class="content_title">
            <h1>
                【ID：{:input('video_id')}】 {$user|user_name}发布的视频 
            </h1>
        ...
        <div class="table_slide">
            <table class="content_list mt_10">
                ...
                <tr>
                    ...
                    <td style="width: 12%;">发布用户</td>
                    <td style="width: 10%;">城市</td>
                    <notempty name="get['master_id']">
                    <td style="width: 12%;">回复用户</td>
                    </notempty>
                    ...
                    <volist name="_list" id="vo">
                        <tr data-id="{$vo.id}">
                            ...
                            <td>
                                ...
                                <a href="{:url('video_comment/_list',['video_id'=>$vo['video_id'],'master_id'=>$vo['id']])}">{$vo.reply_count}</a><br/>
                                <else/>
                                {$vo.reply_count}
                                </if>
                            </td>
