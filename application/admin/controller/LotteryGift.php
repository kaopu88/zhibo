...
class lotteryGift extends Controller
{
    ...
    {
        $this->checkAuth('admin:lottery_gift:select');
        $get = input();
        $lotteryGift = new \app\admin\service\LotteryGift();
    ...
    public function add()
    {
       $this->checkAuth('admin:lottery_gift:add');
        if (Request::isGet()) {
            $get = input();
            ...
            //$has_repeat = Db::name('lottery_gift')->where('gift_id', $post['gift_id'])->find();
    ...
    {
        $this->checkAuth('admin:lottery_gift:edit');
        if (Request::isGet()) {
            $id = input('id');
    ...
    public function del()
    {
        $this->checkAuth('admin:lottery_gift:del');
        $ids = get_request_ids();
