    ...
    <div class="pa_20">
        ...
        <div class="content_toolbar mt_10">
            <ul class="content_toolbar_btns">
                ...
                <!--<auth rules="admin:lottery:lottery_add">
                    <li><a href="{:url('lottery_add')}?__JUMP__"
                           class="base_button base_button_s">新增</a>
                    </li>
                </auth>

                <auth rules="admin:lottery:lottery_delete">
                    <li><a href="{:url('lottery_delete')}" ajax="post" ajax-target="list_id" ajax-confirm class="base_button base_button_s base_button_red">删除</a></li>
                </auth>-->
            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>
                            <div tgradio-not="{:check_auth('admin:lottery:lottery_edit')?'0':'1'}" tgradio-on="1" tgradio-off="0" tgradio-value="{$vo.status}" tgradio-name="status" tgradio="{:url('change_status',array('id'=>$vo['id']))}"></div>
                        </td>

                        <td>
                        <a href="{:url('lottery_edit',array('id'=>$vo['id']))}?__JUMP__">编辑</a><br>
                        <!--<a class="fc_red" ajax-confirm ajax="get" href="{:url('lottery_delete',array('id'=>$vo['id']))}?__JUMP__">删除</a><br>-->
                        <a style="color: #f00" href="{:url('LotteryGift/index',array('id'=>$vo['id']))}?__JUMP__">奖品管理</a><br/>
