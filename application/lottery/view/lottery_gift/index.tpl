                ...
                <notempty name="_list">
                    <volist name="_list" id="vo">
                        <tr data-id="{$vo.id}">
                            ...
                            <td>
                                <div tgradio-not="{:check_auth('admin:lottery_gift:edit')?'0':'1'}" tgradio-on="1" tgradio-off="0" tgradio-value="{$vo.ismust}" tgradio-name="ismust" tgradio-on-name="是" tgradio-off-name="否" tgradio="{:url('change_ismust',array('id'=>$vo['id'],'activity_id'=>$vo['activity_id']))}"></div>
                            </td>
