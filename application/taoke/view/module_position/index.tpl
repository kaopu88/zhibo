            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>{$vo.sort}</td>
                        <td>
                            <div tgradio-not="{:check_auth('taoke:ad_position:update')?'0':'1'}" tgradio-on="1" tgradio-off="0"
                                 tgradio-value="{$vo.status}" tgradio-name="status" tgradio="{:url('changeStatus',array('id'=>$vo['id']))}"></div>
                        </td>
                        <td>
                            <switch name="vo['application_index']">
                                <case value="0">
                                    淘宝
                                </case>
                                <case value="1">
                        ...
                        <td>
                            <auth rules="taoke:ad_position:update">
