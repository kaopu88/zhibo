    ...
    <div class="pa_20">
        ...
        <table class="content_list mt_10">
            ...
            <tr>
                ...
                <td style="width: 5%;">缩略图</td>
                <td style="width: 5%;">置顶</td>
                <td style="width: 5%;">热门</td>
                <td style="width: 5%;">浏览数</td>
                <td style="width: 5%;">点赞数</td>
            ...
            <notempty name="_list">
                <volist name="_list" id="vo">
                    <tr data-id="{$vo.id}">
                        ...
                        <td>
                            <div class="thumb">
                                <a rel="thumb" href="{:img_url($vo['thumb_image'],'','thumb')}" class="thumb thumb_img user_base_avatar fancybox" alt="">
                                    <img src="{:img_url($vo['thumb_image'],'200_200','thumb')}"/>
                                </a>
                            </div>
                        </td>
                        <td>
                            <div tgradio-not="{:check_auth('taoke:bussiness:update')?'0':'1'}" tgradio-on="1" tgradio-off="0"
                                 tgradio-value="{$vo.is_top}" tgradio-name="is_top" tgradio="{:url('setTop',array('id'=>$vo['id']))}"></div>
                        </td>
                        <td>
                            <div tgradio-not="{:check_auth('taoke:bussiness:update')?'0':'1'}" tgradio-on="1" tgradio-off="0"
                                 tgradio-value="{$vo.is_hot}" tgradio-name="is_hot" tgradio="{:url('setHot',array('id'=>$vo['id']))}"></div>
                        </td>
                        <td>{$vo.view_num}</td>
                        <td>{$vo.like_num}</td>
                        <td>{$vo.sort}</td>
                        ...
                        <td>
                            <auth rules="taoke:bussiness:update">
