        ...
        <div class="bean_box opacity">
            ...
            <ul class="bean_list">
                <volist name="_list" id="vo">
                    <li data-id="{$vo.id}" data-price="{$vo.price}" data-bean="{$vo.bean_num}">
                        <div class="gold_row">
            ...
            <input type="hidden" name="bean_id" value="{$_info.bean_id}"/>
            <input type="hidden" name="pay_method" value="{$_info.pay_method}"/>
        </div>
