...
html,body{
    background-color:rgb(48,40,152);
}
...
<body>
    ...
    <div style="position: relative;">
        <img src="__IMAGES__/live_act/gratitude/bg11.png" alt="">
        <div style=" position: absolute;top: 73%;width: 100%;">
            <div class="user_info">您当前还有<span id="chance">{$score|default='0'}</span>次抽奖机会</div>
        </div>
    </div>

    <!--转盘-->
    <include file="activity_component/rotate" />

    <!--活动规则-->
    <div class="container">
        <div class="title">
            <img src="__IMAGES__/live_act/gratitude/top.png" />
            <span>活动规则</span>
        </div>
        <div class="bg rule">
            <p>活动时间：2018-11-20 00:00:00 ~ 2018-11-22 24:00:00</p>
            <p>一路荆棘，一路春光，一路相伴，一路温暖。为回馈广大用户一直以来对{:APP_NAME}的支持与陪伴，平台特推出感恩节回馈活动。
                粉丝回馈：活动期间，粉丝每赠送一次活动专属礼物“感恩有你”，即可获增一次“感恩回馈大转盘”抽奖机会（抽奖机会可累计），奖品多多，福利多多，抽完即止。（粉丝可在“感恩回馈大转盘”抽奖页面查看当前累计的抽奖次数）
                主播回馈：活动期间，火力全开大PK，主播收到任意礼物即可获得相应的活动积分，活动结束后系统将根据活动时间内主播累计的积分进行排名，活动积分前三名的主播将获得丰厚的奖励。（主播的积分信息将在直播间以活动视窗的形式实时展示）</p>
        </div>
        <div style="text-align: center;">
            <span id="icon-bottom" class="arrow-down"></span>
        </div>
        <div class="bottom">
            <img src="__IMAGES__/live_act/gratitude/bom.png" />
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="winners bg">
            ...
            <div class="winners-content">
                <ul>
                    <?php foreach($prize_info as $value){?>
                    <li><?php echo  substr($value['user_id'],0,1).'***'.substr($value['user_id'],-1,2);?></li>
                    <li style='text-align: left;'><?php echo  $value['prize_name'];?></li>
                    <li><?php echo  date('Y-m-d',$value['create_time']);?></li>
                    <?php }?>
                </ul>
            </div>
        </div>
    ...
    <div>
        <div style="width: 95%;margin: 0 auto;">
            <img src="__H5__/images/live_act/gratitude/prize.jpg" alt="">
        </div>
    </div>
