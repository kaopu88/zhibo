...
<head>
    ...
    <style>
        ...
        .app_title h2 {font-size: 2rem; line-height: 2.8rem; margin: 0; padding: .5rem .7rem; color: #333; } .app_title .page-bar {
            position: relative;
            display: flex;
            flex-wrap: nowrap;
            padding: .5rem 0;
        ...
        .app_title .page-bar .avatar img {
            display: block;
            width: 2rem;
            border-radius: 50%;
        }

        .app_title .page-bar .author {
            width: 50%;
            flex: 0 1 auto;
            display: block;
            box-sizing: border-box;
        ...
        .app_title .page-bar .author .t1 {
            font-size: 1.6rem;
            font-weight: 500;
        }

        .app_title .page-bar .author .t2 {
            font-size: 1.4rem;
            color: #b0b0b0;
        }

        .app_title .page-bar .pvs {
            position: absolute;
            right: 0;
            bottom: 0;
            font-size: 1.4rem;
