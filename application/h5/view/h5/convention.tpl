    ...
    <body>
		<div class="" id="slider">
			<section class="main-page current">
				<div >
					<img src="__H5__/images/convention1.jpg?v=__RV__" class="img100" style="display:block;" />
				</div>
				<div>
					<img src="__H5__/images/convention2.jpg?v=__RV__" class="img100" style="display:block;" />
				</div>
				<div>
					<img src="__H5__/images/convention3.jpg?v=__RV__" class="img100" style="display:block;" />
				</div>
			</section>			
		</div>
    </body>
