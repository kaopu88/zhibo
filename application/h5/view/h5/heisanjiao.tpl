    ...
    <body>
		<div class="" id="slider">
			<section class="main-page current">
				<div >
					<img src="__H5__/images/h5display/1.jpg" class="img100" style="display:block;" />
				</div>
				<div>
					<img src="__H5__/images/h5display/3.png" class="img100" style="display:block;" />
				</div>
				<div>
					<img src="__H5__/images/h5display/4.jpg" class="img100" style="display:block;" />	
				</div>
				<div>
					<img src="__H5__/images/h5display/5.jpg" class="img100" style="display:block;" />	
				</div>
			</section>			
		</div>
    </body>
