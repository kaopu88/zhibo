...
<link href="__H5__/css/activity/love-qixi.css" rel="stylesheet" />
...
<body>
    ...
    <main class="p-gift-scramble3">
        <header class="p-gift-scramble3-header">
            <img src="__H5__/images/activity/love_qixi/bg.png" alt="爱的供养" class="p-gift-scramble3-header-slogan" />
        </header>
