        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="cid" selectedval="<?php echo htmlentities($_info['cid']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="type" selectedval="<?php echo htmlentities($_info['type']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="picture_url" value="<?php echo htmlentities($_info['picture_url']); ?>" type="text" class="base_text border_left_radius"/>
                        ...
                        <div imgview="[name=picture_url]" style="width: 120px;margin-top: 10px;"><img src="<?php echo htmlentities($_info['picture_url']); ?>"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="file_path" value="<?php echo htmlentities($_info['file']); ?>" type="text"
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="price" value="<?php echo htmlentities($_info['price']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">折扣</td>
                    <td>
                        <input class="base_text" name="discount" value="<?php echo htmlentities($_info['discount']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">等值<?php echo APP_BEAN_NAME; ?></td>
                    <td>
                        <input class="base_text" name="conv_millet" value="<?php echo htmlentities($_info['conv_millet']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">守护天数(针对守护礼物)</td>
                    <td>
                        <input class="base_text" name="guard_day" value="<?php echo htmlentities($_info['guard_day']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">点击提示信息</td>
                    <td>
                        <input class="base_text" name="tips" value="<?php echo htmlentities($_info['tips']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">总销量</td>
                    <td>
                        <input class="base_text" name="sales" value="<?php echo htmlentities($_info['sales']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">参数</td>
                    <td>
                        <textarea name="show_params" class="base_textarea"><?php echo htmlentities($_info['show_params']); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">特权</td>
                    <td>
                        <select class="base_select" name="privileges" selectedval="<?php echo htmlentities($_info['privileges']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="is_vip" selectedval="<?php echo !empty($_info['is_vip']) ? '1'  :  '0'; ?>">
