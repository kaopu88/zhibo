        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="name" value="<?php echo htmlentities($_info['name']); ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input placeholder="" class="base_text" name="version" value="<?php echo htmlentities($_info['version']); ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input placeholder="" class="base_text" name="code" value="<?php echo htmlentities($_info['code']); ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <select name="os" class="base_select" selectedval="<?php echo htmlentities($_info['os']); ?>">
                            ...
                            <?php $_result=enum_array('packages_os');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$os): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo htmlentities($os['value']); ?>"><?php echo htmlentities($os['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="channel" class="base_select" selectedval="<?php echo htmlentities($_info['channel']); ?>">
                            <?php $_result=enum_array('packages_channel');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo htmlentities($channel['value']); ?>"><?php echo htmlentities($channel['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="url" value="<?php echo htmlentities($_info['url']); ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <select name="update_type" class="base_select" selectedval="<?php echo htmlentities($_info['update_type']); ?>">
                            <?php $_result=enum_array('packages_update_types');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$update_type): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo htmlentities($update_type['value']); ?>"><?php echo htmlentities($update_type['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="file_path" value="<?php echo htmlentities($_info['file_path']); ?>" type="text"
                ...
                <tr>
                    ...
                    <td>
                        <textarea placeholder="" class="base_textarea" name="descr"><?php echo htmlentities($_info['descr']); ?></textarea>
                    </td>
                </tr>
                <tr>
