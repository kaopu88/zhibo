  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        <div class="content_title">
            ...
            <span> &nbsp;&nbsp;&nbsp;&nbsp;<?php if($aid == 1): ?> 充值总计：<span style="color: red"><?php echo htmlentities($total); ?></span> <?php else: ?> 当前页充值总计:<span style="color: red"><?php echo htmlentities($total); ?></span> <?php endif; ?></span>
        ...
        <div class="table_slide">
            <table class="content_list mt_10">
                ...
                <tr>
                    ...
                    <td style="width: 10%"><?php echo config('app.agent_setting.agent_name'); ?></td>
                    <!--                <td style="width: 10%">联系方式</td>-->
                    <td style="width: 10%">用户消费（<?php echo APP_BEAN_NAME; ?>）</td>
                    <!--                <td style="width: 10%">折合RMB（元）</td>-->
                    <td style="width: 10%">用户消费(未分配)</td>
                    <td style="width: 8%">用户充值</td>
                    <td style="width: 8%">苹果充值</td>
                    <td style="width: 15%">收获<?php echo APP_MILLET_NAME; ?></td>
                ...
                <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td>
                                <div class="thumb">
                                    <a href="<?php echo url('agent/detail',['id'=>$vo['id']]); ?>" class="thumb_img">
                                        <img src="<?php echo img_url($vo['logo'],'200_200','logo'); ?>"/>
                                    </a>
                                    <p class="thumb_info">
                                        <a href="<?php echo url('agent/detail',['id'=>$vo['id']]); ?>">
                            ...
                            <!--                        </td>-->
                            <td><?php echo htmlentities($vo['cons']); ?></td>
                            <!--                        <td><?php echo htmlentities(equ_rmb($vo['cons'])); ?></td>-->
                            <td><?php echo htmlentities($vo['unallocated_cons']); ?></td>
                            <td>
                                <?php echo htmlentities($vo['recharge_num']); ?>
                            </td>
                            <td>
                                <?php echo htmlentities($vo['apple_recharge_num']); ?>
                            </td>
                            <td>
                                <?php echo htmlentities($vo['millet']); ?>
                            </td>
                            <td></td>
                        </tr>
