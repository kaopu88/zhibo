    ...
    <p class="thumb_info">
        <a href="<?php echo url('user/detail',['user_id'=>$vo['user']['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['user']['phone'],3,4) ?: '未绑定')); ?>
                                ...
                                <!--<td>
                                    生日：<a href="javascript:;"><?php echo htmlentities($vo['birth']); ?></a><br/>
                                    性别：<a href="javascript:;"><?php echo htmlentities($vo['sex_str']); ?></a><br/>
                                    行政编码：<a href="javascript:;"><?php echo htmlentities($vo['addr_code']); ?></a><br/>
                                    地址：<a href="javascript:;"><?php echo htmlentities($vo['province']); ?><?php echo htmlentities($vo['city']); ?><?php echo htmlentities($vo['area']); ?><?php echo htmlentities($vo['addr']); ?></a>
                                </td>-->
                                <td>
                                    真实姓名：<a href="javascript:;"><?php echo htmlentities($vo['name']); ?></a><br/>
                                    证件类型：<a href="javascript:;"><?php echo htmlentities($vo['idcard_type_str']); ?></a><br/>
                                    证件号：<a href="javascript:;"><?php echo htmlentities($vo['card_num']); ?></a>
                                </td>
                                <td>
                                    <div class="thumb">
                                        <a rel="thumb" href="<?php echo img_url($vo['front_idcard'],'','thumb'); ?>" class="thumb thumb_img user_base_avatar fancybox" alt="">
                                            <img src="<?php echo img_url($vo['front_idcard'],'200_200','thumb'); ?>"/>
                                        </a>
                                    </div>
                                </td>
                                <td>
                                    <div class="thumb">
                                        <a rel="thumb" href="<?php echo img_url($vo['back_idcard'],'','thumb'); ?>" class="thumb thumb_img user_base_avatar fancybox" alt="">
                                            <img src="<?php echo img_url($vo['back_idcard'],'200_200','thumb'); ?>"/>
                                        </a>
                                    </div>
                                </td>
                                <td>
                                    <div class="thumb">
                                        <a rel="thumb" href="<?php echo img_url($vo['hand_idcard'],'','thumb'); ?>" class="thumb thumb_img user_base_avatar fancybox" alt="">
                                            <img src="<?php echo img_url($vo['hand_idcard'],'200_200','thumb'); ?>"/>
                                        </a>
                                    </div>
                                </td>
                                <td>
                                    <?php switch($vo['status']): case "0": ?>
                                        ...
                                        <?php break; endswitch; if($vo['status'] !== '0' || !empty($vo['handle_desc'])): ?>
                                        <br/>处理详情：<?php echo htmlentities($vo['handle_desc']); endif; ?>
                                </td>

                                <td>
                                    <?php switch($vo['is_anchor']): case "0": ?>
                                            会员中心实名
                                        <?php break; case "1": ?>
                                            主播申请实名
                                        <?php break; endswitch; ?>
                                ...
                                <td>
                                    <?php switch($vo['status']): case "0": if(check_auth('admin:user_verified:audit',AUTH_UID)): ?>
                                                <a data-id="id:<?php echo htmlentities($vo['id']); ?>" poplink="verified_handler"
                                                   href="javascript:;">处理</a><br/>
                                            <?php endif; ?>
                                            <a data-query="id=<?php echo htmlentities($vo['id']); ?>&type=user_verified" poplink="task_transfer_box"
...
<div dom-key="work_box" popbox="work_box" class="work_box layer_box" title="任务设置"
    ...
    <div title="实名认证申请" class="layer_box verified_handler pa_10" dom-key="verified_handler" popbox-action="<?php echo url('user_verified/handler'); ?>">
