            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div style="float: left">
                        <?php if(check_auth('admin:robot:add',AUTH_UID)): ?>
                            <a onclick="redirect_to('<?php echo url('add'); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>')" class="base_button base_button_s">新增</a>
                            <input class="base_text" name="robot_num" value="1" style="width: 60px;"/>个机器人
                        <?php endif; if(check_auth('admin:robot:delete',AUTH_UID)): ?>
                    ...
                    <tr data-id="<?php echo htmlentities($vo['user_id']); ?>">
                        ...
                        <td>
                            <div class="thumb">
                                ...
                                <p class="thumb_info">
                                    <a href="javascript:;">
                                        用户名：<?php echo htmlentities($vo['username']); ?><br/>
                                        昵称：<?php echo htmlentities($vo['nickname']); ?>
                                    </a>
                                </p>
                            </div>
                        </td>
                        <td>
                            <?php switch($vo['gender']): case "0": ?>
                                    保密
                                <?php break; case "1": ?>
                                    男
                                <?php break; case "2": ?>
                        ...
                        <td>
                            <?php echo htmlentities(time_format($vo['birthday'],'无','date')); ?>
                        </td>
                        <td>
                            <?php echo htmlentities($vo['province_name']); ?><br>
                            <?php echo htmlentities($vo['city_name']); ?><br>
                            <?php echo htmlentities($vo['district_name']); ?>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['create_time'],'无','date')); ?>
                        </td>
                        <td>
                            <?php if(check_auth('admin:robot:update',AUTH_UID)): ?>
                                <a href="<?php echo url('edit',array('user_id'=>$vo['user_id'])); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>">编辑</a>
                            <?php endif; if(check_auth('admin:robot:delete',AUTH_UID)): ?>
                                <a class="fc_red" ajax-confirm ajax="get" href="<?php echo url('delete',array('id'=>$vo['user_id'])); ?>">删除</a>
                            <?php endif; ?>
                        </td>
                    </tr>
