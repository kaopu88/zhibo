            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div style="float: left">
                        ...
                        <?php endif; if(check_auth('admin:poster:edit',AUTH_UID)): ?>
                            <a href="<?php echo url('clear'); ?>" ajax="post" ajax-target="list_id" ajax-confirm class="base_button base_button_s base_button_red">清除海报</a>
                        <?php endif; ?>
                    </div>
        ...
        <div class="table_slide">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>
                            <div class="thumb">
                                <a rel="thumb" href="<?php echo img_url($vo['bg_url'],'','thumb'); ?>" class="thumb thumb_img user_base_avatar fancybox" alt="">
                                    <img src="<?php echo img_url($vo['bg_url'],'200_200','cover'); ?>"/>
                                </a>
                            </div>
                        </td>
                        <td>
                            <div tgradio-not="<?php echo check_auth('admin:poster:edit')?'0':'1'; ?>" tgradio-on="1"
                                 tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['status']); ?>"
                                 tgradio-name="status"
                                 tgradio="<?php echo url('poster/change_status',['id'=>$vo['id']]); ?>"></div>
                        </td>
                        <td>
