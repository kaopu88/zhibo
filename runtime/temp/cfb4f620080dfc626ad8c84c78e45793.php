...
<div class="main">
  ...
  <div class="sub_catalog"></div>
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        <input placeholder="发起人ID" type="text" name="user_id" value="<?php echo input('user_id'); ?>"/>
                        <input placeholder="选手ID" type="text" name="to_user_id" value="<?php echo input('to_user_id'); ?>"/>
                        <input placeholder="ID、交易单号" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
        ...
        <div class="table_slide">
         <table class="content_list mt_10 md_width">
            ...
            <tr>
                ...
                <td style="width: 10%;">消费<?php echo APP_BEAN_NAME; ?>数</td>
    ...
    <?php endif; ?>
                        ...
                        <td>
                            <?php echo htmlentities($vo['votes']); ?>
                        </td>
                        <td>
                            <?php echo htmlentities($vo['bean']); ?>
                        </td>
                        <td>
