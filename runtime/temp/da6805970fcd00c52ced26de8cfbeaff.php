    ...
    <div class="pa_20">
        ...
        <div class="content_toolbar mt_10">
            <ul class="content_toolbar_btns">
                <?php if(check_auth('admin:complaint:category_add',AUTH_UID)): ?>
                ...
                <?php endif; if(check_auth('admin:complaint:category_delete',AUTH_UID)): ?>
            ...
            <div class="content_toolbar_search">
                <div class="base_group">
                    ...
                    <div class="modal_select modal_select_s">
                        <span class="modal_select_text"></span>
                        <input name="target" type="hidden" class="modal_select_value finder"
                               value="<?php echo input('target'); ?>"/>
                        <ul class="modal_select_list">
                            <li class="modal_select_option" value="">适用对象</li>
                            <li class="modal_select_option" value="user">用户</li>
                            <li class="modal_select_option" value="comment">评论</li>
                            <li class="modal_select_option" value="film">小视频</li>
                            <li class="modal_select_option" value="music">歌词</li>
                        </ul>
                    </div>
        ...
        <table class="content_list mt_10 sm_width">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>
                            <span class="fc_green">
                                <?php switch($vo['target']): case "user": ?>
                                        用户
                                    <?php break; case "comment": ?>
                                        评论
                                    <?php break; case "film": ?>
                                        小视频
                        ...
                        <td>
                            <div tgradio-not="<?php echo check_auth('admin:complaint:category_edit')?'0':'1'; ?>" tgradio-on="1" tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['status']); ?>" tgradio-name="status" tgradio="<?php echo url('change_status',array('id'=>$vo['id'])); ?>"></div>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['create_time'])); ?>
                        </td>
                        <td>
                            <?php if(check_auth('admin:complaint:category_edit',AUTH_UID)): ?>
                                <a href="<?php echo url('category_edit',array('id'=>$vo['id'])); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>">编辑</a><br/>
                            <?php endif; if(check_auth('admin:complaint:category_delete',AUTH_UID)): ?>
