    ...
    <div class="pa_20">
        ...
        <div class="content_toolbar mt_10">
            <ul class="content_toolbar_btns">
                <?php if(check_auth('admin:notice:add',AUTH_UID)): ?>
                ...
                <?php endif; if(check_auth('admin:notice:delete',AUTH_UID)): ?>
                ...
                <div class="base_group">
                    ...
                    <div class="modal_select modal_select_s">
                        ...
                        <ul class="modal_select_list">
                            ...
                            <li class="modal_select_option" value="2"><?php echo config('app.agent_setting.agent_name'); ?></li>
                        </ul>
                    </div>
                    <div class="modal_select modal_select_s">
                        <span class="modal_select_text"></span>
                        <input name="barrage" type="hidden" class="modal_select_value finder"
                               value="<?php echo input('barrage'); ?>"/>
                        <ul class="modal_select_list">
        ...
        <div class="table_slide">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>admin</td>
                        <td><?php echo !empty($vo['visible']) ? ($vo['visible'] == 1 ? '总后台'  :  config('app.agent_setting.agent_name')) : '全部'; ?></td>
                        <td><?php echo !empty($vo['barrage']) ? '开启'  :  '关闭'; ?></td>
                        <td>
                            <div tgradio-not="<?php echo check_auth('admin:notice:update')?'0':'1'; ?>" tgradio-on="1" tgradio-off="0"
                        ...
                        <td>
                            <?php if(check_auth('admin:notice:update',AUTH_UID)): ?>
                                <a href="<?php echo url('edit',array('id'=>$vo['id'])); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>">编辑公告</a><br/>
                            <?php endif; if(check_auth('admin:notice:delete',AUTH_UID)): ?>
                                <a class="fc_red" ajax-confirm ajax="get" href="<?php echo url('del',array('id'=>$vo['id'])); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>">删除公告</a>
                            <?php endif; ?>
                        </td>
                    </tr>
