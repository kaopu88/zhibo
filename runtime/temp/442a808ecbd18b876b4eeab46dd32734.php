...
<script>
    layui.use(['element', 'layer'], function(){
        ...
        <div class="bg_form">
            <form action="<?php echo url('video'); ?>">
                        ...
                        <div class="layui-tab-item layui-show">
                            <table class="content_info2 mt_10">
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[platform]" selectedval="<?php echo htmlentities($_info['platform']); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="vod[platform_config][secret_id]" value="<?php echo htmlentities($_info['platform_config']['secret_id']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">应用Key</td>
                                    <td>
                                        <input class="base_text" name="vod[platform_config][secret_key]" value="<?php echo htmlentities($_info['platform_config']['secret_key']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">应用End_point</td>
                                    <td>
                                        <input class="base_text" name="vod[platform_config][end_point]" value="<?php echo htmlentities($_info['platform_config']['end_point']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">应用Region</td>
                                    <td>
                                        <input class="base_text" name="vod[platform_config][region]" value="<?php echo htmlentities($_info['platform_config']['region']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">应用Token</td>
                                    <td>
                                        <input class="base_text" name="vod[platform_config][token_url]" value="<?php echo htmlentities($_info['platform_config']['token_url']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">签名单次有效</td>
                                    <td>
                                        <select class="base_select" name="vod[platform_config][one_time_valid]" selectedval="<?php echo htmlentities($_info['platform_config']['one_time_valid']); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[platform_config][sign_method]" selectedval="<?php echo htmlentities($_info['platform_config']['sign_method']); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[platform_config][source_context]" selectedval="<?php echo htmlentities($_info['platform_config']['source_context']); ?>">
                                ...
                                <tr class="edit_tr">
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[platform_config][ProcessMedia]" selectedval="<?php echo htmlentities($_info['platform_config']['ProcessMedia']); ?>">
                        ...
                        <!--<div class="layui-tab-item">
                            ...
                            <table class="content_info2 mt_10">
                                <tr>
                                    <td class="field_name">应用Id</td>
                                    <td>
                                        <input class="base_text" name="live_config[qiniu_live][secret_id]" value="<?php echo htmlentities($_live_config['qiniu_live']['secret_id']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">应用Access_key</td>
                                    <td>
                                        <input class="base_text" name="live_config[qiniu_live][access_key]" value="<?php echo htmlentities($_live_config['qiniu_live']['access_key']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">应用Secret_key</td>
                                    <td>
                                        <input class="base_text" name="live_config[qiniu_live][secret_key]" value="<?php echo htmlentities($_live_config['qiniu_live']['secret_key']); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="layui-tab-item">
                            <table class="content_info2 mt_10">
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[audit_config][status]" selectedval="<?php echo htmlentities($_info['audit_config']['status']); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[audit_config][verified_status]" selectedval="<?php echo htmlentities($_info['audit_config']['verified_status']); ?>">
                                            <option value="2">开启</option>
                                            <option selected value="1">关闭</option>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[audit_config][creation_status]" selectedval="<?php echo htmlentities($_info['audit_config']['creation_status']); ?>">
                                            <option value="2">开启</option>
                                            <option selected value="1">关闭</option>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[audit_config][isvirtual_status]" selectedval="<?php echo htmlentities($_info['audit_config']['isvirtual_status']); ?>">
                                            <option value="2">开启</option>
                                            <option selected value="1">关闭</option>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="vod[audit_config][isadvideo_status]" selectedval="<?php echo htmlentities($_info['audit_config']['isadvideo_status']); ?>">
                                            <option value="2">开启</option>
                                            <option selected value="1">关闭</option>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="vod[audit_config][credit_score]" value="<?php echo htmlentities($_info['audit_config']['credit_score']); ?>"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select show_type" name="vod[audit_config][vido_show]" selectedval="<?php echo htmlentities($_info['audit_config']['vido_show']); ?>">
                                ...
                                <tr class="weight" <?php if($_info['audit_config']['vido_show'] == '0'): ?>style ="display:none"<?php endif; ?>>
                                <td class="field_name">推荐权重值</td>
                                <td>
                                    <input class="base_text" name="vod[audit_config][recomment_weight]" value="<?php echo htmlentities($_info['audit_config']['recomment_weight']); ?>"/>
                                    <span>用于视频推荐展现</span>
                                </td>
                                </tr>
                                ...
                                <td>
                                    <input class="base_text" name="vod[audit_config][identification_weight]" value="<?php echo htmlentities($_info['audit_config']['identification_weight']); ?>"/>
                                ...
                                <tr class="weight" <?php if($_info['audit_config']['vido_show'] == '0'): ?>style ="display:none"<?php endif; ?>>
                                    ...
                                    <td>
                                        <input class="base_text" name="vod[audit_config][comment_weight]" value="<?php echo htmlentities($_info['audit_config']['comment_weight']); ?>"/>
                                        <span>用于视频推荐展现</span>
                                    </td>
                                </tr>
                                ...
                                <tr class="weight" <?php if($_info['audit_config']['vido_show'] == '0'): ?>style ="display:none"<?php endif; ?>>
                                    ...
                                    <td>
                                        <input class="base_text" name="vod[audit_config][zan_weight]" value="<?php echo htmlentities($_info['audit_config']['zan_weight']); ?>"/>
                                        <span>用于视频推荐展现</span>
                                    </td>
                                </tr>
                                ...
                                <tr class="weight" <?php if($_info['audit_config']['vido_show'] == '0'): ?>style ="display:none"<?php endif; ?>>
                                    ...
                                    <td>
                                        <input class="base_text" name="vod[audit_config][share_weight]" value="<?php echo htmlentities($_info['audit_config']['share_weight']); ?>"/>
                                        <span>用于视频推荐展现</span>
                                    </td>
                                </tr>
                                ...
                                <td>
                                    <input class="base_text" name="vod[audit_config][exposure]" value="<?php echo htmlentities($_info['audit_config']['exposure']); ?>"/>
