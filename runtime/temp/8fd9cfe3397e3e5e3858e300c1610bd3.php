            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        ...
                        <input placeholder="圈子内容" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
        ...
        <div class="table_slide">
            <table class="content_list mt_10">
                ...
                <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <tr data-id="<?php echo htmlentities($vo['circle_id']); ?>">
                            <td><input class="list_id" type="checkbox" name="ids[]" value="<?php echo htmlentities($vo['circle_id']); ?>"/></td>
                            <td><?php echo htmlentities($vo['circle_id']); ?></td>
                            <td>
                                <div class="thumb">
    ...
    <p class="thumb_info">
        <a href="<?php echo url('admin/user/detail',['user_id'=>$vo['user']['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['user']['phone'],3,4) ?: '未绑定')); ?>
                            ...
                            <td>
                                <?php echo htmlentities((isset($vo['circle_name']) && ($vo['circle_name'] !== '')?$vo['circle_name']:'--')); ?>
                            ...
                            <td>
                                <div tgradio-not="<?php echo check_auth('friend:friend:change_recom')?'0':'1'; ?>" tgradio-on="1"
                                     ...
                                     tgradio="<?php echo url('circle/change_recom',['id'=>$vo['circle_id']]); ?>"></div>
                            </td>
                            <td>
                                <div tgradio-not="<?php echo check_auth('friend:friend:change_status')?'0':'1'; ?>" tgradio-on="1"
                                     ...
                                     tgradio="<?php echo url('circle/change_status',['id'=>$vo['circle_id']]); ?>"></div>
                            </td>
                            <td>
                                <?php if(check_auth('friend:friend:update',AUTH_UID)): ?>
                                    <a href="<?php echo url('edit',array('id'=>$vo['circle_id'])); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>">编辑</a><br/>
                                <?php endif; ?>
