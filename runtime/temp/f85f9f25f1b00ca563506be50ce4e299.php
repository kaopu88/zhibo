  ...
  <div class="sub_catalog"></div>
        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    ...
                    <td>
                        <div typecl="<?php echo url('resources/get_tree'); ?>">
                            <input type="hidden" class="type_val_0" name="pcat_id" value="<?php echo htmlentities($_info['pcat_id']); ?>">
                            <input type="hidden" class="type_val_1" name="cat_id" value="<?php echo htmlentities($_info['cat_id']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="name" value="<?php echo htmlentities($_info['name']); ?>" onBlur="checkName(this.value)"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="image" value="<?php echo htmlentities($_info['image']); ?>" type="text"
                        ...
                        <div imgview="[name=image]" style="width: 120px;margin-top: 10px;"><img
                                    src="<?php echo img_url('','','image'); ?>"/></div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="hot" selectedval="<?php echo htmlentities($_info['hot']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="new" selectedval="<?php echo htmlentities($_info['new']); ?>">
                            <option value="1">是</option>
                            <option value="0">否</option>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input placeholder="数值越大越靠前" class="base_text" name="sort" value="<?php echo htmlentities($_info['sort']); ?>"/>
                    </td>
                </tr>
                <tr>
    ...
    <script>
        function checkName(name){
            ...
            $s.post('<?php echo url("check_name"); ?>', {
                pcat_id: pcat_id,
                name: name,
            }, function (result) {
                if(result.status==1){
