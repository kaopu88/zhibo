            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        <input placeholder="用户ID、昵称" type="text" name="user_keyword" value="<?php echo input('user_keyword'); ?>"/>
                        <input placeholder="歌曲ID、标题" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
                        <button class="filter_search_submit">搜索</button>
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
            <input type="hidden" name="scene" value="<?php echo input('scene'); ?>"/>
        </div>
    ...
    <p class="thumb_info">
        <a href="<?php echo url('user/detail',['user_id'=>$vo['user']['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['user']['phone'],3,4) ?: '未绑定')); ?>
                        ...
                        <td><?php echo htmlentities($vo['scene_str']); ?></td>
                        <td>
                            <?php echo htmlentities(time_format($vo['update_time'])); ?>
                        </td>
                        <td>
