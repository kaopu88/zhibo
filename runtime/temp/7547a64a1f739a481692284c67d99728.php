  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <input class="base_text" name="id" value="<?php echo htmlentities($_info['id']); ?>" style="display: none"/>
            <table class="content_info2 mt_10">
                <tr>
                    <td class="field_name">用户ID</td>
                    <td>
                        <input class="base_text" name="user_id" value="<?php echo htmlentities($_info['user_id']); ?>" readonly/>
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group" style="float: left;width: 25%;">
                            ...
                            <input style="width: 309px;" name="cover_url" value="<?php echo htmlentities($_info['cover_url']); ?>" type="text" class="base_text border_left_radius"/>
                        ...
                        <div imgview="[name=cover_url]" style="width: 120px;margin-left: 5px;"><img style="height: 40px" src="<?php echo htmlentities($_info['cover_url']); ?>" class="preview"/></div>
                </tr>

                <tr>
                    <td class="field_name">直播分类</td>
                    <td>
                        <select class="base_select" name="room_channel" selectedval="<?php echo htmlentities($_info['room_channel']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" id="select_type" name="type" selectedval="<?php echo htmlentities($_info['type']); ?>" onchange="func()">
                ...
                <tr  <?php if($_info['type'] == 0): ?> style="display: none" <?php endif; ?>  id="type">
                    <td class="field_name" >密码或价格</td>
                    <td>
                        <input class="base_text" name="type_val" value="<?php echo htmlentities($_info['type_val']); ?>"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="pull" value="<?php echo htmlentities($_info['pull']); ?>" style="float: left"/>
