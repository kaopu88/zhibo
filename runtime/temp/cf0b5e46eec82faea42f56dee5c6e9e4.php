...
<head lang="en">
    ...
    <script src="/static/vendor/Tdrag.js?v=<?php echo config('upload.resource_version'); ?>"></script>
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="bg_url" value="<?php echo htmlentities($_info['bg_url']); ?>" type="text" class="base_text border_left_radius"/>
                        ...
                        <div class="boxList" style="width: 320px;height: 504px;margin-top: 10px;border: 1px solid #ccc; background: url(<?php echo htmlentities($_info['bg_url']); ?>) no-repeat; background-size:320px 504px;" >
                            <div class="one div3" style="position: absolute;margin: 0px;z-index: 888;left: <?php echo htmlentities($_info['data']['width']); ?>px;top: <?php echo htmlentities($_info['data']['height']); ?>px;">
                                <input id="x3" class="base_text"  style="display: none" name="width" value="<?php echo htmlentities($_info['data']['width']); ?>"/>
                                <input id="y3" class="base_text" style="display: none" name="height" value="<?php echo htmlentities($_info['data']['height']); ?>"/>
                            </div>

                            <div class="div4" style="position: absolute;width: 48px;height: 22px;border: 1px solid #0a0a0a;;color: white;font-size: 16px;font-weight:bold;z-index: 1001;left:<?php echo htmlentities($_info['data']['fontwidth']); ?>px;top: <?php echo htmlentities($_info['data']['fontheight']); ?>px;">
                                <input id="x4" class="base_text" style="display: none"  name="fontwidth" value="<?php echo htmlentities($_info['data']['fontwidth']); ?>"/>
                                <input id="y4" class="base_text" style="display: none" name="fontheight" value="<?php echo htmlentities($_info['data']['fontheight']); ?>"/>
                                邀请码
                            </div>
