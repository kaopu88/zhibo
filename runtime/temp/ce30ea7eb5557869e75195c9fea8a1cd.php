    ...
    <div class="pa_20">
        ...
        <table class="content_list mt_10 md_width">
            ...
            <tr>
                ...
                <td style="width: 20%;">收获<?php echo APP_MILLET_NAME; ?></td>
    ...
    <p class="thumb_info">
        <a href="<?php echo url('anchor/detail',['user_id'=>$vo['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['phone'],3,4) ?: '未绑定')); ?>
                        ...
                        <td>
                            <a href="<?php echo url('anchor/detail',['user_id'=>$vo['user_id']]); ?>">主播详情</a>
                        </td>
                    </tr>
