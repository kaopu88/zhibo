...
<div class="main">
  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <form action="<?php echo isset($_info['levelid'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    <td class="field_name">标题</td>
                    <td>
                        <input class="base_text" name="levelname" value="<?php echo htmlentities($_info['levelname']); ?>" onBlur="checkName(this.value)"/>
                        <input name="name" type="hidden" value="<?php echo htmlentities($_info['name']); ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            ...
                            <a uploader-crop="1" uploader-size="2147483648" uploader-type="image" href="javascript:;"
                               ...
                               uploader="anchor_exp_level_icon"
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="level_up" value="<?php echo htmlentities($_info['level_up']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name"></td>
                    <td>
                        <?php if(isset($_info['levelid'])): ?>
                            <input name="levelid" type="hidden" value="<?php echo htmlentities($_info['levelid']); ?>"/>
                        <?php endif; ?>
