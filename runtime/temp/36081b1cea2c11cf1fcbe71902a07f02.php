    ...
    <div class="pa_20">
        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    <td class="field_name">父频道</td>
                    <td>
                        <select class="base_select" name="parent_id" selectedval="<?php echo htmlentities($_info['parent_id']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="icon" value="<?php echo htmlentities($_info['icon']); ?>" type="text" class="base_text border_left_radius"/>
                            <a uploader-crop="1" uploader-size="2147483648" uploader-type="image" href="javascript:;"
                               class="base_button border_right_radius"
                               uploader="live_channel_icon"
                               uploader-field="icon">上传</a>
                        </div>
                        <div imgview="[name=icon]" style="width: 120px;margin-top: 10px;"><img src="<?php echo htmlentities($_info['icon']); ?>"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <textarea name="description" class="base_textarea"><?php echo htmlentities($_info['description']); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">排序</td>
                    <td>
                        <input class="base_text" name="sort_order" value="<?php echo htmlentities($_info['sort_order']); ?>"/>
                    </td>
                </tr>
                <tr>
