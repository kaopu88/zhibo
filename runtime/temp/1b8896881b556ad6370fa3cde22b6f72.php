    ...
    <p class="thumb_info">
        <a href="<?php echo url('user/detail',['user_id'=>$vo['user']['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['user']['phone'],3,4) ?: '未绑定')); ?>
                            ...
                            <td>
                                <div class="thumb">
                                    ...
                                    <a class="thumb_img thumb_img_avatar">
                                        <img src="<?php echo htmlentities($vo['cover_url']); ?>"/>
                                    </a>
                                    <?php endif; ?>
                                    <p class="thumb_info">
                            ...
                            <td>
                                <?php echo htmlentities($vo['contact']); ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php switch($vo['audit_status']): case "0": if(check_auth('admin:viewback:audit',AUTH_UID)): ?>
...
<div dom-key="work_box" popbox="work_box" class="work_box layer_box" title="任务设置"
    ...
    <div title="处理反馈申请" class="layer_box viewback_handler pa_10" dom-key="viewback_handler" popbox-action="<?php echo url('viewback/handler'); ?>">
