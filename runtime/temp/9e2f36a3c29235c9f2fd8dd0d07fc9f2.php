<?php /*a:3:{s:60:"/www/wwwroot/zhibb/application/admin/view/video/tcplayer.tpl";i:1592625950;s:64:"/www/wwwroot/zhibb/application/admin/view/public/base_iframe.tpl";i:1592625950;s:61:"/www/wwwroot/zhibb/application/admin/view/public/jsconfig.tpl";i:1602499828;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
    ...
    <script src="/static/vendor/TcPlayer/TcPlayer-2.2.2.js?v=<?php echo config('upload.resource_version'); ?>" charset="utf-8"></script>

</head>
<body>

    <div class="video_title">
        <div class="video_text"><?php echo htmlentities(short($film['title'],20)); ?></div>
    </div>
    <div id="my_video" style="width:100%; height:auto;"></div>
    <script>
        var player = new TcPlayer('my_video', {
            "mp4": "<?php echo htmlentities($film['video_url']); ?>",
            "autoplay": true,
            "coverpic": "<?php echo htmlentities($film['cover_url']); ?>",
            "width": '414',
            "height": '736'
        });
    </script>
