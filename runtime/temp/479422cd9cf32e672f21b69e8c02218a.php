            ...
            <div class="table_slide">
                <table class="content_info2 mt_10 font_normal table_fixed sm_width">
                    <tr>
                        ...
                        <td>
                            <select class="base_select" name="lottery_is_open" selectedval="<?php echo !empty($_info['lottery_is_open']) ? '1'  :  '0'; ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="lottery_desc" class="base_text" style="height: 120px;"><?php echo htmlentities($_info['lottery_desc']); ?></textarea>
                        </td>
                    </tr>
