            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        ...
                        <input placeholder="视频ID、描述" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
                        ...
                        <td>
                            <div class="thumb">
                                <a layer-title="0" layer-area="414px,779px"
                                   layer-open="<?php echo url('video/tcplayer',['id'=>$vo['video_id']]); ?>" href="javascript:;"
