...
<div class="main">
  ...
  <div class="sub_catalog"></div>
        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="mark" value="<?php echo htmlentities($_info['mark']); ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="type" selectedval="<?php echo htmlentities($_info['type']); ?>">
                            ...
                            <?php $_result=enum_array('ad_space_types');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?>
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="length" value="<?php echo htmlentities((isset($_info['length']) && ($_info['length'] !== '')?$_info['length']:1)); ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input name="platform" type="hidden" value="<?php echo htmlentities($_info['platform']); ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input name="img_config" type="hidden" value="<?php echo htmlentities($_info['img_config']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">广告配置</td>
                    <td>
                        <textarea placeholder="JSON格式" class="base_textarea" name="config"><?php echo htmlentities($_info['config']); ?></textarea>
                    </td>
                </tr>
                <tr>
    ...
    <script>
        var platformOptions = JSON.parse('<?php echo json_encode(config("enum.ad_os")); ?>');
