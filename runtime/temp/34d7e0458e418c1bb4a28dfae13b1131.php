            ...
            list: [
                {
                    name: 'type',
                    title: '消息模式',
                    opts: <?php echo htmlspecialchars_decode($_sendtypeArray); ?>
                },
                {
                    name: 'extend_type',
                    title: '发布类型',
                    opts: <?php echo htmlspecialchars_decode($_extendArray); ?>
                },
                {
                    name: 'msg_type',
                    title: '发给',
                    opts: <?php echo htmlspecialchars_decode($_acceptArray); ?>
                },
                {
                    name: 'status',
                    title: '审核',
                    opts: <?php echo htmlspecialchars_decode($_earry); ?>
                }
            ]
        };
    </script>
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        <input placeholder="标题或内容" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
                        ...
                        <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                            ...
                            <td>
                                <div class="thumb">
                                    ...
                                    <p class="thumb_info">
                                        <?php echo htmlentities(short($vo['dynamic_title'],'20')); ?>
                                    </p>
                                </div>
                            </td>
                            <td>
    ...
    <p class="thumb_info">
        <a href="<?php echo url('admin/user/detail',['user_id'=>$vo['user']['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['user']['phone'],3,4) ?: '未绑定')); ?>
                            ...
                            <td>
                                <?php if(!(empty($vo['picture']) || (($vo['picture'] instanceof \think\Collection || $vo['picture'] instanceof \think\Paginator ) && $vo['picture']->isEmpty()))): ?>
                                    <a rel="thumb" href="<?php echo img_url($vo['picture'][0],'','thumb'); ?>" class="thumb thumb_img user_base_avatar fancybox" alt="">
                                    <img src="<?php echo htmlentities($vo['picture'][0]); ?>" style="width: 80px;height: 80px"/>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if(!(empty($vo['video']) || (($vo['video'] instanceof \think\Collection || $vo['video'] instanceof \think\Paginator ) && $vo['video']->isEmpty()))): ?>
                                    <div class="thumb">
    <a layer-title="0" layer-area="414px,779px"
       layer-open="<?php echo url('friend/tcplayer',['id'=>$vo['id']]); ?>" href="javascript:;"
       class="thumb_img" style="display: inline-block;max-width: 100px;">
        <img src="<?php echo img_url($vo['animate_url']?$vo['animate_url']:$vo['cover_url'],'120_68','film_cover'); ?>"/>
                            ...
                            <td>
                                <?php if(!(empty($vo['voice']) || (($vo['voice'] instanceof \think\Collection || $vo['voice'] instanceof \think\Paginator ) && $vo['voice']->isEmpty()))): ?>
                                    <p class="thumb_info">
                                        <a href="<?php echo htmlentities($vo['voice']); ?>" target="_blank">
                                            <span class="fc_red">[音频]</span><br/>
                                            <?php echo htmlentities($vo['dynamic_title']); ?><br/>
                                        </a>
                                    </p>
                                <?php endif; ?>
                            ...
                            <td>
                                发布时间：<?php echo htmlentities(time_format($vo['create_time'],'暂无','datetime')); ?><br/>
                            </td>
                            <td>
                                <?php echo htmlentities((isset($vo['sendtype']) && ($vo['sendtype'] !== '')?$vo['sendtype']:'--')); ?>

                            </td>
                            <td>
                                <?php echo htmlentities((isset($vo['sendto']) && ($vo['sendto'] !== '')?$vo['sendto']:'--')); ?>

                            </td>
                            <td>
                                <div tgradio-not="<?php echo check_auth('friend:friend:change_recom')?'0':'1'; ?>" tgradio-on="1"
                                    tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['is_recommend']); ?>"
                                    tgradio-name="status" tgradio-on-name="推荐" tgradio-off-name="普通"
                                    tgradio="<?php echo url('friend/change_recom',['id'=>$vo['id']]); ?>"></div>
                            </td>
                            <td>
                                <div tgradio-not="<?php echo check_auth('friend:friend:change_status')?'0':'1'; ?>" tgradio-on="1"
                                    tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['status']); ?>"
                                    tgradio-name="status" tgradio-on-name="启用" tgradio-off-name="关闭"
                                    tgradio="<?php echo url('friend/change_status',['id'=>$vo['id']]); ?>"></div>
                            </td>
                            <td>
                                ...
                                <?php endif; if(check_auth('friend:friend:deleteLog',AUTH_UID)): ?>
