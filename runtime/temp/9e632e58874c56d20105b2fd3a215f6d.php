...
<head lang="en">
    ...
    <script>
        var config = {
            item_name: '菜单',
            parent_key: 'pid',
            get_tree: '<?php echo url("get_tree"); ?>',
            del_url: '<?php echo url("del"); ?>',
    ...
    <div class="pa_20">
        ...
        <div class="content_toolbar mt_10">
            <ul class="content_toolbar_btns menu_btns">
                ...
                <?php if(check_auth('admin:menu:add',AUTH_UID)): ?>
                    <li><a href="javascript:;" class="base_button base_button_s add_btn">新增</a></li>
                <?php endif; if(check_auth('admin:menu:delete',AUTH_UID)): ?>
                ...
                <?php endif; if(check_auth('admin:setting:data_update',AUTH_UID)): ?>
                    <li style="line-height: 30px;font-size: 12px;padding-left: 10px;">
                        <a data-to="menu:<?php echo htmlentities($data_v); ?>" class="update_data_version" href="javascript:;"><?php echo $data_v=='last'?'已更新至最新版本':'更新至:'.$data_v; ?></a>
                    </li>
                <?php endif; ?>
            </ul>
