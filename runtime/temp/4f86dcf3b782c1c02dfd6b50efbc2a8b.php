...
<script>
    layui.use(['element', 'layer'], function(){
        ...
        <div class="bg_form">
            <form action="<?php echo url('beauty'); ?>">
                        ...
                        <div class="layui-tab-item layui-show">
                            <table class="content_info2 mt_10">
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="beauty_setting[beauty_status]" selectedval="<?php echo !empty($_info['beauty_setting']['beauty_status']) ? htmlentities($_info['beauty_setting']['beauty_status']) :  '0'; ?>">
