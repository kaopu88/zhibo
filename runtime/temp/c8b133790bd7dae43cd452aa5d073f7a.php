...
<div class="main">
  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <form action="<?php echo isset($_info['cate_id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    <td class="field_name">分类名称</td>
                    <td>
                        <input class="base_text" name="cate_name" value="<?php echo htmlentities($_info['cate_name']); ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input suggester-value="[name=user_id]" suggester="<?php echo url('admin/user/get_suggests',['taoke_shop'=>1]); ?>" style="width: 309px;" value="<?php echo htmlentities($_info['nickname']); ?>" type="text" class="base_text user_id border_left_radius"/>
                            <input type="hidden" name="user_id" value="<?php echo htmlentities($_info['user_id']); ?>"/>
                            <a fill-value="[name=user_id]" fill-name=".user_id" layer-open="<?php echo url('admin/user/find', ['taoke_shop'=>1]); ?>" href="javascript:;" class="base_button base_button_gray border_right_radius">选择</a>
                        </div>
                        <div class="clear"></div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input placeholder="数值越大越靠前" class="base_text" name="sort" value="<?php echo htmlentities((isset($_info['sort']) && ($_info['sort'] !== '')?$_info['sort']:999)); ?>"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(isset($_info['cate_id'])): ?>
                            <input name="cate_id" type="hidden" value="<?php echo htmlentities($_info['cate_id']); ?>"/>
                            <input name="shop_id" type="hidden" value="<?php echo htmlentities($_info['shop_id']); ?>"/>
                        <?php endif; ?>
