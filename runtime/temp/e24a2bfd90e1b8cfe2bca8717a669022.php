...
<div class="main">
  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        ...
                        <input placeholder="主播ID" type="text" name="anchor_id" value="<?php echo input('anchor_id'); ?>"/>
                        <input placeholder="订单号、直播间ID、标题" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
        ...
        <div class="table_slide">
            ...
            <tr>
                ...
                <td style="width: 10%;">付费额度(<?php echo APP_BEAN_NAME; ?>)</td>
                <td style="width: 10%;">实付额度(<?php echo APP_BEAN_NAME; ?>)</td>
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><?php echo htmlentities($vo['trade_no']); ?></td>
                        <td><?php echo htmlentities($vo['room_id']); ?></td>
                        <td><?php echo htmlentities($vo['room_title']); ?></td>
                        <td><?php echo htmlentities($vo['room_model_txt']); ?></td>
                        <td>
                            <div class="thumb">
    ...
    <?php endif; ?>
                        ...
                        <td><?php echo htmlentities($vo['room_bean']); ?></td>
                        <td><?php echo htmlentities($vo['pay_bean']); ?></td>
                        <td>
                            <?php echo htmlentities(time_format($vo['create_time'],'无')); ?>
                        </td>
                    </tr>
