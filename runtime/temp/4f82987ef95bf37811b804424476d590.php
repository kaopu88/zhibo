            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        <input placeholder="歌手ID、名称" type="text" name="user_keyword" value="<?php echo input('user_keyword'); ?>"/>
                    ...
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>
                            <div class="thumb">
                                ...
                                <p class="thumb_info">
                                    <a href="javascript:;">
                                        <?php echo htmlentities($vo['singer_name']); ?>
                                    </a>
                                </p>
                            </div>
                        </td>
                        ...
                        <td>
                            <?php echo htmlentities($vo['channel_album_id']); ?>
                        </td>
                        <td><?php echo htmlentities($vo['desc']); ?></td>
                        <td>
                            <?php echo htmlentities(time_format($vo['release_time'],'无','date')); ?>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['create_time'],'无','date')); ?>
                        </td>
                        <td>
                            <?php if(check_auth('admin:music_album:update',AUTH_UID)): ?>
