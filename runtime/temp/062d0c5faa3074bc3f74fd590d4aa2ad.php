<?php /*a:1:{s:64:"/www/wwwroot/zhibb/application/h5/view/h5/apply_labour_union.tpl";i:1650878162;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title><?php echo htmlentities($_agentName); ?>申请</title>
    <link rel="stylesheet" href="/static/h5/css/vant/index.css">
    <link rel="stylesheet" type="text/css" href="/static/h5/css/applylabourunion/index.css"/>
...
<div id="guildApply" v-cloak>
    <van-skeleton title avatar :row="3" :loading="loading">
        ...
        <van-form @submit="onSubmit" style="margin-top: 0.2703rem;">
            <van-field v-model="guild_name" name="guild_name" label="<?php echo htmlentities($_agentName); ?>名称" placeholder="请输入您要创建的<?php echo htmlentities($_agentName); ?>名称"
                       :rules="[{ required: true, message: '请填写<?php echo htmlentities($_agentName); ?>名称' }]" :border="false"></van-field>
    ...
    new Vue({
        ...
        data() {
            return {
                ...
                cardList: [
                    {
                        img: '/static/h5/images/h5labourunion/image_focused_txm@2x.png',
                        info: '身份证头像面'
                    },
                    {
                        img: '/static/h5/images/h5labourunion/image_focused_ghm@2x.png',
                        info: '身份证国徽面'
                    },
                    {
                        img: '/static/h5/images/h5labourunion/image_focused_yyzz@2x.png',
                        info: '<?php echo htmlentities($_agentName); ?>背景图片'
                    }
                ],
                imgIndex: "",
