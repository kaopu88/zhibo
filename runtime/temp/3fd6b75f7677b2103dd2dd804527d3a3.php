                ...
                <div class="content_toolbar_search">
                    <div class="base_group">
                        ...
                        <input placeholder="用户ID" name="keyword" class="base_text base_text_s finder" style="width:180px;"
                            value="<?php echo input('keyword'); ?>" placeholder=""/>
    ...
    <p class="thumb_info">
        <a href="<?php echo url('user/detail',['user_id'=>$vo['user']['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['user']['phone'],3,4) ?: '未绑定')); ?>
                                ...
                                <td>
                                    <?php echo htmlentities($vo['fans_num']); ?>
                                </td>
                                <td>
                                    <?php echo htmlentities($vo['film_num']); ?>
                                </td>
                                <td>
                                    <?php echo htmlentities($vo['reported_num']); ?>
                                </td>
                                <td>
                                    <?php echo !empty($vo['verified']) ? '是'  :  '否'; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php switch($vo['status']): case "0": if(check_auth('admin:creation:audit',AUTH_UID)): ?>
                                                <a data-id="id:<?php echo htmlentities($vo['id']); ?>" poplink="creation_handler"
                                                href="javascript:;">处理</a><br/>
                                            <?php endif; ?>
                                            <a data-query="id=<?php echo htmlentities($vo['id']); ?>&type=audit_creation" poplink="task_transfer_box"
...
<div dom-key="work_box" popbox="work_box" class="work_box layer_box" title="任务设置"
    ...
    <div title="处理反馈申请" class="layer_box creation_handler pa_10" dom-key="creation_handler" popbox-action="<?php echo url('creation/handler'); ?>">
