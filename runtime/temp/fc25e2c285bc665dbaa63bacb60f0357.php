        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="apple_id" value="<?php echo htmlentities($_info['apple_id']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">单价</td>
                    <td>
                        <input class="base_text" name="rmb" value="<?php echo htmlentities($_info['rmb']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">等值<?php echo config('app.product_info.bean_name'); ?></td>
                    <td>
