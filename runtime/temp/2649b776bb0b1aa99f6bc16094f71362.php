            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        ...
                        <input placeholder="主播ID、昵称" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
                    ...
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>
                            <div class="thumb">
                                ...
                                <p class="thumb_info">
                                    <?php echo htmlentities(short($vo['nickname'],'20')); ?>
                                </p>
                            </div>
                        </td>
                        <td>
                            房间ID：<?php echo htmlentities($vo['room_id']); ?><br/>
                            标题：<?php echo htmlentities($vo['title']); ?><br/>
                            房间模式：<?php echo htmlentities($vo['room_model_txt']); ?><br/>
                            房间频道：<?php echo htmlentities($vo['channel_info']['name']); ?><br/>
                            直播类型：<?php echo htmlentities($vo['type_txt']); ?><br/>
                            类型值：<?php echo htmlentities((isset($vo['type_val']) && ($vo['type_val'] !== '')?$vo['type_val']:'暂无')); ?>
                        </td>
                        <td>
                            观众数：<?php echo htmlentities((isset($vo['real_audience']) && ($vo['real_audience'] !== '')?$vo['real_audience']:'0')); ?><br/>
                            机器人：<?php echo htmlentities((isset($vo['robot']) && ($vo['robot'] !== '')?$vo['robot']:'0')); ?><br/>
                            实时显：<?php echo htmlentities($vo['real_audience']*2+$vo['robot']*20); ?>
                        </td>
                        <td>
                            <?php echo htmlentities($vo['province']); ?><br>
                            <?php echo htmlentities($vo['city']); ?><br>
                            <?php echo htmlentities($vo['district']); ?>
                        </td>
                        <td><?php echo htmlentities($vo['profit']); ?></td>
                        <td>
                            开播时间：<?php echo htmlentities(time_format($vo['start_time'],'暂无','datetime')); ?><br/>
                            结束时间：<?php echo htmlentities(time_format($vo['end_time'],'暂无','datetime')); ?>
                        </td>
                    </tr>
