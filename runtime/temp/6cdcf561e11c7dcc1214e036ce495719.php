    ...
    <div class="pa_20">
        ...
        <div class="content_toolbar mt_10">
            <ul class="content_toolbar_btns">
                <?php if(check_auth('admin:lottery_gift:add',AUTH_UID)): ?>
                    <li>
                        <a href="<?php echo url('add',array('activity_id'=>$activity_id)); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>"
                           class="base_button base_button_s">新增</a>
                    </li>
                <?php endif; ?>

                <!--<?php if(check_auth('admin:lottery_gift:del',AUTH_UID)): ?>
            ...
            <table class="content_list mt_10">
                ...
                <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                            ...
                            <td>
                                <img src="<?php echo htmlentities($vo['image']); ?>" width="60" alt="">
                            </td>

                            <td>
                                <?php echo htmlentities($vo['probability']); ?>
                            </td>
                            ...
                            <td>
                                <div tgradio-not="<?php echo check_auth('admin:lottery_gift:edit')?'0':'1'; ?>" tgradio-on="1" tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['ismust']); ?>" tgradio-name="ismust" tgradio-on-name="是" tgradio-off-name="否" tgradio="<?php echo url('change_ismust',array('id'=>$vo['id'],'activity_id'=>$vo['activity_id'])); ?>"></div>
                            </td>

                            <td>
                                <div tgradio-not="<?php echo check_auth('admin:lottery_gift:edit')?'0':'1'; ?>" tgradio-on="1" tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['status']); ?>" tgradio-name="status" tgradio="<?php echo url('change_status',array('id'=>$vo['id'])); ?>"></div>
                            </td>
                            ...
                            <a href="<?php echo url('edit',array('id'=>$vo['id'])); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>">编辑</a>
                              ...
                              <!--  <br>
                            <a class="fc_red" ajax-confirm ajax="get" href="<?php echo url('del',array('id'=>$vo['id'])); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>">删除</a>-->
                            </td>
