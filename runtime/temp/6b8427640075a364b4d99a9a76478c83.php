            ...
            list: [
                {
                    name: 'type',
                    title: '工作类型',
                    get: '<?php echo url("common/get_work_types"); ?>'
                }
            ]
        };
        $(function () {
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        <input placeholder="任务人ID" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
        ...
        <table class="content_list mt_10">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>
                            ID:<?php echo htmlentities($vo['aid']); ?><br>
                            realname:<?php echo htmlentities($vo['admin_info']['realname']); ?>
                        </td>
                        <td><?php echo htmlentities((isset($vo['type_name']) && ($vo['type_name'] !== '')?$vo['type_name']:$vo['type'])); ?></td>
                        <td><?php echo htmlentities($vo['unread_num']); ?>/<?php echo htmlentities($vo['task_num']); ?></td>
                        <td>
                            <div tgradio-not="0"
                                 tgradio-on="1"
                                 ...
                                 tgradio="<?php echo url('change_status',['aid'=> $vo['aid'], 'id'=>$vo['type']]); ?>"></div>
                        </td>
                        <td>
                            <div tgradio-not="0"
                                 tgradio-on="1"
                                 tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['sms_status']); ?>"
                                 tgradio-name="sms_status"
                                 tgradio-on-name="开启"
                                 tgradio-off-name="关闭"
                                 tgradio="<?php echo url('change_sms_status',['aid'=>$vo['aid'], 'id'=>$vo['type']]); ?>"></div>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['offline_time'],'','datetime')); ?>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['last_time'],'','datetime')); ?>
                        </td>
                        <td>
