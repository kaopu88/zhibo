    ...
    <div class="pa_20">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        <input placeholder="ID、名称" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
        ...
        <div class="table_slide">
            ...
            <tr>
                ...
                <td style="width: 15%;">类型名称</td>
                <td style="width: 7%;">支付方式名称</td>
                <td style="width: 7%;">别名</td>
                <td style="width: 7%;">支付方式LOGO</td>
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><?php echo htmlentities($vo['class_name']); ?></td>
                        <td><?php echo htmlentities($vo['name']); ?></td>
                        <td><?php echo htmlentities($vo['alias']); ?></td>
                        <td>
                            <div class="thumb">
                                <a href="javascript:;"
                                   class="thumb_img thumb_img_avatar">
                                    <img src="<?php echo img_url($vo['thumb'],'200_200','thumb'); ?>"/>
                                </a>
                            </div>
                        </td>
                        <td><?php echo htmlentities($vo['list_order']); ?></td>
                        <td>
                            <div tgradio-not="<?php echo check_auth('admin:payments:update')?'0':'1'; ?>" tgradio-on="1"
                                 tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['status']); ?>"
                                 tgradio-name="status"
                                 tgradio="<?php echo url('payments/change_status',['id'=>$vo['id']]); ?>"></div>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['addtime'],'无','date')); ?>
                        </td>
                        <td>
                            <?php if(check_auth('admin:payments:update',AUTH_UID)): ?>
