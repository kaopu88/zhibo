                ...
                <div class="filter_order">
                    <ul class="content_toolbar_btns">
                        <div style="float: left">
                            <a href="<?php echo url('batch_pass'); ?>" ajax="post" ajax-target="list_id" ajax-confirm
        ...
        <img src="<?php echo img_url($vo['animate_url']?$vo['animate_url']:$vo['cover_url'],'120_68','film_cover'); ?>"/>
                            ...
                            <td>
                                <?php if(check_auth('friend:friend:update',AUTH_UID)): ?>
                                    <a href="<?php echo url('edit',array('id'=>$vo['id'])); ?>?<?php echo ('redirect='.urlencode(\think\facade\Request::url())); ?>">查看</a><br/>
                                <?php endif; ?>
                            </td>
                        </tr>
