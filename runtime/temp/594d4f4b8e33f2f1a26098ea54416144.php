    ...
    <p class="thumb_info">
        <a href="<?php echo url('user/detail',['user_id'=>$vo['user']['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['user']['phone'],3,4) ?: '未绑定')); ?>
                        ...
                        <td>
                            <?php switch($vo['audit_status']): case "-1": ?>
                                    系统审核中
                                <div ajax="post" ajax-url="<?php echo url('UserDataDeal/submit_mq',['id'=>$vo['id']]); ?>"
                        ...
                        <td>
                            ...
                            处理：<?php if($vo['handle_time'] != '0'): ?><?php echo htmlentities(time_format($vo['handle_time'],'未处理')); else: ?>未处理<?php endif; if($vo['audit_status'] != '0'): if($vo['audit_status'] != '-1'): ?>
                                <br/>详情：<?php echo htmlentities($vo['handle_desc']); endif; endif; ?>
                        </td>
                    </tr>
