        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input placeholder="" suggest-value="[name=props_id]" suggest="<?php echo url('props/get_suggests'); ?>"
                                   style="width: 309px;" value="<?php echo htmlentities($_info['prop']); ?>" type="text" class="base_text prop border_left_radius" name="prop">
                            <input type="hidden" name="props_id" value="<?php echo htmlentities($_info['props_id']); ?>">
                            <a fill-value="[name=props_id]" fill-name=".prop" layer-open="<?php echo url('props/find'); ?>"
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="length" value="<?php echo htmlentities($_info['length']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">单位</td>
                    <td>
                        <select class="base_select" name="unit" selectedval="<?php echo htmlentities($_info['unit']); ?>">
