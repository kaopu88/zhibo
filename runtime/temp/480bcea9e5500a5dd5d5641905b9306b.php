        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="author_id" selectedval="<?php echo htmlentities($_info['author_id']); ?>">
                            <option value="">请选择</option>
                            <?php if(is_array($restAuthor) || $restAuthor instanceof \think\Collection || $restAuthor instanceof \think\Paginator): $i = 0; $__LIST__ = $restAuthor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?>
