  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <div class="filter_box mt_10">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        <input placeholder="手机号、模板ID" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
            ...
            <input type="hidden" name="is_code" value="<?php echo htmlentities($get['is_code']); ?>"/>
        </div>
        <div class="table_slide">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><span class="fc_green">+<?php echo htmlentities($vo['phone_code']); ?></span>&nbsp;<?php if($admin['id'] == '1'): ?> <?php echo htmlentities($vo['phone']); else: ?><?php echo htmlentities((str_hide($vo['phone'],3,4) ?: '')); endif; ?></td>
                        <td><?php echo htmlentities($vo['template']); ?></td>
                        <td><?php echo htmlentities($vo['content']); ?></td>
                        <td><?php echo htmlentities($vo['result']['Message']); ?></td>
                        <td><?php echo !empty($vo['is_code']) ? '是'  :  '否'; ?></td>
                        <td>
                        ...
                        <td>
                            <?php echo htmlentities(time_format($vo['send_time'])); ?>
                        </td>
                    </tr>
