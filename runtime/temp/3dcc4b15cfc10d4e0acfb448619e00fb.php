  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <div class="filter_box mt_10">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        ...
                        <input placeholder="被关注用户ID" type="text" name="follow_id" value="<?php echo input('follow_id'); ?>"/>
            ...
            <input type="hidden" name="ismutual" value="<?php echo input('ismutual'); ?>"/>
        </div>
