        ...
        var myConfig = {
            list: [
                ...
                },
                {
                    name: 'trade_type',
                    title: '交易类型',
                    opts: JSON.parse('<?php echo json_encode(enum_array("trade_types")); ?>')
                }
            ]
        };
    </script>
    <script src="<?php echo ('/static/'.strtolower(\think\facade\Request::module()).'/js'); ?>/bean_log/index.js?v=<?php echo config('upload.resource_version'); ?>"></script>
        ...
        <div class="filter_box mt_10">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <?php if(!(empty($total_amount) || (($total_amount instanceof \think\Collection || $total_amount instanceof \think\Paginator ) && $total_amount->isEmpty()))): ?><a href="javascipt:;">总计：<?php echo htmlentities($total_amount); ?></a><?php endif; ?>
                    <div class="filter_search">
                        ...
                        <input placeholder="ID、流水单号、交易单号" type="text" name="keyword" value="<?php echo input('keyword'); ?>" style="width: 166px;"/>
                        <button class="filter_search_submit">搜索</button>
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
            <input type="hidden" name="type" value="<?php echo htmlentities($get['type']); ?>"/>
            <input type="hidden" name="trade_type" value="<?php echo htmlentities($get['trade_type']); ?>"/>
        </div>
