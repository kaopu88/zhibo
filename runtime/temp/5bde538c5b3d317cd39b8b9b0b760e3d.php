        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="visible" selectedval="<?php echo htmlentities($_info['visible']); ?>">
                            <option value="0">全部</option>
                            <option value="1">总后台</option>
                            <option value="2"><?php echo config('app.agent_setting.agent_name'); ?></option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea style="width:900px;height:400px;" name="content" ueditor><?php echo htmlentities($_info['content']); ?></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="barrage" selectedval="<?php echo htmlentities($_info['barrage']); ?>">
