  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <div class="filter_box mt_10">
            ...
            <input type="hidden" name="gender" value="<?php echo htmlentities($get['gender']); ?>"/>
            <input type="hidden" name="classify" value="<?php echo htmlentities($get['classify']); ?>"/>
        ...
        <div class="table_slide">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><?php echo htmlentities($vo['birth']); ?></td>
                        <td><?php echo htmlentities($vo['country']); ?></td>
                        <td><?php echo htmlentities($vo['languages']); ?></td>
                        <td>
                            第三方id：<a href="javascript:;"><?php echo htmlentities($vo['channel_singer_id']); ?></a><br/>
                            歌手简介：<a href="javascript:;"><?php echo htmlentities($vo['intro']); ?></a><br/>
                            歌曲数量：<a href="<?php echo url('music/index',array('singer_id'=>$vo['id'])); ?>"><?php echo htmlentities($vo['songs_total']); ?></a><br/>
                            mv数量：<a href="javascript:;"><?php echo htmlentities($vo['mv_total']); ?></a><br/>
                            专辑数量：<a href="<?php echo url('music_album/index',array('singer_id'=>$vo['id'])); ?>"><?php echo htmlentities($vo['albums_total']); ?></a>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['create_time'],'无','date')); ?>
                        </td>
                        <td>
                            <?php if(check_auth('admin:music_singer:update',AUTH_UID)): ?>
