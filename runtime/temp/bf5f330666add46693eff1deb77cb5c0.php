...
<script>
    ...
    <script>
        ...
        function getSignature() {
          return axios.post('<?php echo url('video/getsignature'); ?>').then(function (response) {
