        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="class_name" value="<?php echo htmlentities($_info['class_name']); ?>"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="alias" value="<?php echo htmlentities($_info['alias']); ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="thumb" value="<?php echo htmlentities($_info['thumb']); ?>" type="text" class="base_text border_left_radius"/>
                        ...
                        <div imgview="[name=thumb]" style="width: 120px;margin-top: 10px;"><img src="<?php echo htmlentities($_info['thumb']); ?>"/>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="list_order" value="<?php echo htmlentities($_info['list_order']); ?>"/>
                    </td>
                </tr>
                <tr>
                  ...
                  <tr>
                    ...
                    <td>
                         <?php if(is_array($rechargeList) || $rechargeList instanceof \think\Collection || $rechargeList instanceof \think\Paginator): $i = 0; $__LIST__ = $rechargeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$recharg): $mod = ($i % 2 );++$i;?>
                               <label>
                            
                                   <input checkedval="<?php echo htmlentities($_info['coin_type']); ?>" style="vertical-align: -1px;" type="checkbox" name="coin_type[]" value="<?php echo htmlentities($recharg['id']); ?>" />
                                   &nbsp;<?php echo htmlentities($recharg['bean_num']); ?><?php echo htmlentities($recharg['name']); ?>- ¥<?php echo htmlentities($recharg['bean_num']); ?>.00&nbsp;
