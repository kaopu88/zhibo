                ...
                <div class="filter_order">
                    <ul class="content_toolbar_btns">
                        <?php if($_isopen  != '1'): ?>
                            ...
                            <?php if(check_auth('taoke:bussiness:add',AUTH_UID)): ?>
                                <li><a href="<?php echo url('changeopen?is_open=1'); ?>" ajax="post" ajax-target="list_id" ajax-confirm class="base_button base_button_s base_button_red">开启个人任务</a></li>
                            <?php endif; else: ?>
                            <p style="color: green">当前的任务处于开启状态 ! </p>
                            <?php if(check_auth('taoke:bussiness:delete',AUTH_UID)): ?>
                                <li><a href="<?php echo url('changeopen?is_open=0'); ?>" ajax="post" ajax-target="list_id" ajax-confirm class="base_button base_button_s base_button_red">关闭个人任务</a></li>
                            <?php endif; endif; ?>

                    </ul>
                    <div class="filter_search">
                        <input placeholder="标题" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
            ...
            <table class="content_list mt_10 table_fixed" >
                ...
                <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                            ...
                            <td>
                                <?php echo htmlentities(short($vo['task_type'],'20')); ?>
                            </td>
                            <td>
                                <?php echo htmlentities(short($vo['type'],'20')); ?>
                            </td>
                            <td>
                                <?php echo htmlentities(short($vo['mission_type'],'20')); ?>
                            </td>
                            ...
                            <td>
                                <div tgradio-not="<?php echo check_auth('friend:Lyrics:change_status')?'0':'1'; ?>" tgradio-on="1"
                                     ...
                                     tgradio="<?php echo url('TaskSet/change_status',['id'=>$vo['id']]); ?>"></div>
                            </td>
                            <td>
