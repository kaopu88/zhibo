...
<script>
    layui.use(['element', 'layer'], function(){
        ...
        <div class="bg_form">
            <form action="<?php echo url('payment'); ?>">
                        ...
                        <div class="layui-tab-item layui-show">
                            <table class="content_info2 mt_10">
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="alipay[app_id]" value="<?php echo htmlentities($_info['alipay']['app_id']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">支付公钥</td>
                                    <td>
                                        <textarea name="alipay[alipay_public_key]" class="base_text" style="height: 120px;"><?php echo htmlentities($_info['alipay']['alipay_public_key']); ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">支付私钥</td>
                                    <td>
                                        <textarea name="alipay[alipay_private_key]" class="base_text" style="height: 120px;"><?php echo htmlentities($_info['alipay']['alipay_private_key']); ?></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex_start">
                                            <input class="base_text w_307" name="alipay[alipay_public_cert]" value="<?php echo htmlentities($_info['alipay']['alipay_public_cert']); ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex_start">
                                            <input class="base_text w_307" name="alipay[alipay_private_cert]" value="<?php echo htmlentities($_info['alipay']['alipay_private_cert']); ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="alipay[charset]" value="<?php echo htmlentities($_info['alipay']['charset']); ?>"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="alipay[sign_type]" value="<?php echo htmlentities($_info['alipay']['sign_type']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">请求地址</td>
                                    <td>
                                        <input class="base_text" name="alipay[gateway_url]" value="<?php echo htmlentities($_info['alipay']['gateway_url']); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="layui-tab-item">
                            <table class="content_info2 mt_10">
                                <tr>
                                    <td class="field_name">APPID</td>
                                    <td>
                                        <input class="base_text" name="wxpay[app_id]" value="<?php echo htmlentities($_info['wxpay']['app_id']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">商户号</td>
                                    <td>
                                        <input class="base_text" name="wxpay[mch_id]" value="<?php echo htmlentities($_info['wxpay']['mch_id']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">KEY</td>
                                    <td>
                                        <input class="base_text" name="wxpay[mch_key]" value="<?php echo htmlentities($_info['wxpay']['mch_key']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">APPSECRET</td>
                                    <td>
                                        <input class="base_text" name="wxpay[app_secret]" value="<?php echo htmlentities($_info['wxpay']['app_secret']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex_start">
                                            <input class="base_text w_307" name="wxpay[wxpay_public_cert]" value="<?php echo htmlentities($_info['wxpay']['wxpay_public_cert']); ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex_start">
                                            <input class="base_text w_307" name="wxpay[wxpay_private_cert]" value="<?php echo htmlentities($_info['wxpay']['wxpay_private_cert']); ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="wxpay[report_levenl]" value="<?php echo htmlentities($_info['wxpay']['report_levenl']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">代理服务器IP</td>
                                    <td>
                                        <input class="base_text" name="wxpay[wxpay_proxy_host]" value="<?php echo htmlentities($_info['wxpay']['wxpay_proxy_host']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">代理服务器端口</td>
                                    <td>
                                        <input class="base_text" name="wxpay[wxpay_proxy_port]" value="<?php echo htmlentities($_info['wxpay']['wxpay_proxy_port']); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="layui-tab-item">
                            <table class="content_info2 mt_10">
                                <tr>
                                    ...
                                    <td>
                                        <select class="base_select" name="applepay[sandbox]" selectedval="<?php echo !empty($_info['applepay']['sandbox']) ? '1'  :  '0'; ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="applepay[sandbox_verify_receipt]" value="<?php echo htmlentities($_info['applepay']['sandbox_verify_receipt']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">验证地址</td>
                                    <td>
                                        <input class="base_text" name="applepay[verify_receipt_url]" value="<?php echo htmlentities($_info['applepay']['verify_receipt_url']); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="layui-tab-item">
                            <table class="content_info2 mt_10">
                                <tr>
                                    <td class="field_name">APPID</td>
                                    <td>
                                        <input class="base_text" name="wxpay_wap[app_id]" value="<?php echo htmlentities($_info['wxpay_wap']['app_id']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">商户号</td>
                                    <td>
                                        <input class="base_text" name="wxpay_wap[mch_id]" value="<?php echo htmlentities($_info['wxpay_wap']['mch_id']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">KEY</td>
                                    <td>
                                        <input class="base_text" name="wxpay_wap[mch_key]" value="<?php echo htmlentities($_info['wxpay_wap']['mch_key']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="field_name">APPSECRET</td>
                                    <td>
                                        <input class="base_text" name="wxpay_wap[app_secret]" value="<?php echo htmlentities($_info['wxpay_wap']['app_secret']); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
