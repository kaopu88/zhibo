        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="cover_icon" value="<?php echo htmlentities($_info['cover_icon']); ?>" type="text" class="base_text border_left_radius"/>
                        ...
                        <div imgview="[name=cover_icon]" style="width: 120px;margin-top: 10px;"><img src="<?php echo htmlentities($_info['cover_icon']); ?>"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="user_icon" value="<?php echo htmlentities($_info['user_icon']); ?>" type="text" class="base_text border_left_radius"/>
                            <a uploader-size="2147483648" uploader-type="image" href="javascript:;"
                               class="base_button border_right_radius"
                               uploader="props_user_icon"
                               uploader-field="user_icon">上传</a>
                        </div>
                        <div imgview="[name=user_icon]" style="width: 120px;margin-top: 10px;"><img src="<?php echo htmlentities($_info['user_icon']); ?>"/>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="file_url" value="<?php echo htmlentities($_info['file_url']); ?>" type="text"
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="action_desc" class="base_textarea"><?php echo htmlentities($_info['action_desc']); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">描述</td>
                    <td>
                        <textarea name="describe" class="base_textarea"><?php echo htmlentities($_info['describe']); ?></textarea>
                    </td>
                </tr>
                <tr>
