        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            ...
            <table class="content_info2 mt_10">
                    ...
                    <td>
                        <div class="base_group">
                            <input placeholder="" suggest-value="[name=gift_id]" suggest="/admin/gift/get_suggests.html"
                                   style="width: 309px;" value="<?php echo htmlentities($_info['name']); ?>" type="text" class="base_text gift border_left_radius">
                            <input type="hidden" name="gift_id" value="<?php echo htmlentities($_info['gift_id']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="probability" value="<?php echo htmlentities($_info['probability']); ?>"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="desc" class="base_text" style="height:120px;"><?php echo htmlentities($_info['desc']); ?></textarea>
                    </td>
                </tr>
                ...
                <input class="find_params" type="hidden" name="activity_id" value="<?php echo htmlentities($activity_id); ?>"/>
