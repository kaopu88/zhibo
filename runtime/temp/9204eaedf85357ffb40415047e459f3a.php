...
<head lang="en">
    ...
    <script>
        var getInfoUrl = '<?php echo url("film_tags/get_info"); ?>',
            addTypeUrl = '<?php echo url("film_tags/add"); ?>',
            editTypeUrl = '<?php echo url("film_tags/edit"); ?>',
            pid = '<?php echo htmlentities($_pid); ?>';
    </script>
    <script src="<?php echo ('/static/'.strtolower(\think\facade\Request::module()).'/js'); ?>/film_tags/index.js?v=<?php echo config('upload.resource_version'); ?>"></script>
    ...
    <div class="pa_20">
        ...
        <div class="content_toolbar mt_10">
            <ul class="content_toolbar_btns">
                <?php if(check_auth('admin:film_tags:add',AUTH_UID)): ?>
                    <li><a href="javascript:;" class="base_button base_button_s add_btn">新增</a></li>
                <?php endif; if(check_auth('admin:film_tags:delete',AUTH_UID)): ?>
                    <li>
                        <a href="<?php echo url('film_tags/delete'); ?>" ajax="post" ajax-target="list_id" ajax-confirm class="base_button base_button_s base_button_red">删除</a>
                    </li>
                <?php endif; ?>
            </ul>
        ...
        <div class="table_slide">
            ...
            <tr>
                <td colspan="9">
                    <?php if(is_array($_path) || $_path instanceof \think\Collection || $_path instanceof \think\Paginator): $i = 0; $__LIST__ = $_path;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pa): $mod = ($i % 2 );++$i;?>
                        <a href="<?php echo url('film_tags/index',array('pid'=>$pa['id'])); ?>"><?php echo htmlentities($pa['name']); ?></a>&nbsp;>&nbsp;
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </td>
            </tr>
            <tr class="thead_tr">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td><a href="<?php echo url('film_tags/index',array('pid'=>$vo['id'])); ?>"><?php echo htmlentities($vo['name']); ?></a></td>
                        <td><?php echo htmlentities($vo['descr']); ?></td>
                        ...
                        <td>
                            <?php if(check_auth('admin:film_tags:update',AUTH_UID)): ?>
                                <a data-id="<?php echo htmlentities($vo['id']); ?>" class="edit_btn" href="javascript:;">编辑</a>
                            <?php endif; if(check_auth('admin:film_tags:delete',AUTH_UID)): ?>
                                <a class="fc_red" ajax-confirm ajax="get" href="<?php echo url('film_tags/delete',array('id'=>$vo['id'])); ?>">删除</a>
                            <?php endif; ?>
                        </td>
                    </tr>
    ...
    <div class="pa_10">
        <table class="content_info2">
            <tr>
                ...
                <td>
                    <div typecl="<?php echo url('film_tags/get_tree'); ?>">
