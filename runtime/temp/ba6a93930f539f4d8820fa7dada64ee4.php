...
<script>
    layui.use(['element', 'layer'], function(){
        ...
        <div class="table_slide">
            ...
            <tbody>
            <?php if(!(empty($charm_rank) || (($charm_rank instanceof \think\Collection || $charm_rank instanceof \think\Paginator ) && $charm_rank->isEmpty()))): if(is_array($charm_rank) || $charm_rank instanceof \think\Collection || $charm_rank instanceof \think\Paginator): $i = 0; $__LIST__ = $charm_rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <p class="thumb_info">
        ...
        <?php if($vo['agent_num'] != '0'): ?>
            <br/><?php echo config('app.agent_setting.agent_name'); ?>：<?php echo htmlentities($vo['agent_name']); endif; ?>
                        ...
                        <td>
                            <a data-query="user_id=<?php echo htmlentities($vo['user_id']); ?>&interval=<?php echo input('interval'); ?>&millet=<?php echo htmlentities($vo['millet']); ?>&name=charm<?php if($get['rnum'] != ''): ?>&rnum=<?php echo htmlentities($get['rnum']); endif; ?>" poplink="millet_handler"
