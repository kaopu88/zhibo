<?php /*a:2:{s:57:"/www/wwwroot/zhibb/application/h5/view/creative/index.tpl";i:1657526058;s:54:"/www/wwwroot/zhibb/application/h5/view/public/head.tpl";i:1595042494;}*/ ?>
<!DOCTYPE html>
...
<title><?php echo APP_NAME; ?>创作号认证</title>
<style type="text/css">
...
<section>
    <section class="section" style="margin-top: 0px">
        <img class="banner" src="/static/h5/images/creative/banner.png" alt="">
    </section>

    <section class="section">
        <h3 class="title">什么是创作号</h3>
        <p class="summary">
            <?php echo APP_PREFIX_NAME; ?>创作号作为<?php echo APP_PREFIX_NAME; ?>特色视频创作者的统一称谓。坚持原创、展示创意才华、秀出自我魅力，就是<?php echo APP_PREFIX_NAME; ?>创作号。创作号将享有<?php echo APP_PREFIX_NAME; ?>平台全球范围曝光。
        </p>
    </section>
    ...
    <section class="section">
        ...
        <div class="tq">
            <div>
                <p><img class="liberty" src="/static/h5/images/creative/rz.png" alt=""></p>
                <p class="explain">专属认证</p>
            </div>

            <div>
                <p><img class="liberty" src="/static/h5/images/creative/t.png" alt=""></p>
                <p class="explain">特权免费</p>
            </div>

            <div>
                <p><img class="liberty" src="/static/h5/images/creative/ll.png" alt=""></p>
                <p class="explain">千万流量</p>
            </div>

            <div>
                <p><img class="liberty" src="/static/h5/images/creative/rmb.png" alt=""></p>
                <p class="explain">商业变现</p>
            </div>

            <div>
                <p><img class="liberty" src="/static/h5/images/creative/bg.png" alt=""></p>
    ...
    <section class="section">
        ...
        <div class="summary">
            <ol>
                ...
                <?php if($creation_report_record == 1): ?>
    ...
    <section class="section">
        ...
        <div class="summary">
            <ol>
                <li>粉丝数≥<?php echo htmlentities($creation_fans_num); ?>;</li>
                <li>原创视频数≥<?php echo htmlentities($creation_film_num); ?>;</li>
                <?php if($creation_report_record == 1): ?>
                    <li>遵守社区规则，没有违规或被举报记录;</li>
                <?php endif; ?>
            </ol>
