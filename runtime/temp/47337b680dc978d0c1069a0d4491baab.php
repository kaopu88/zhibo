        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="mission_type" selectedval="<?php echo htmlentities($_info['mission_type']); ?>">
                            <option value="">请选择</option>
                            <?php if(is_array($_erarry) || $_erarry instanceof \think\Collection || $_erarry instanceof \think\Paginator): $i = 0; $__LIST__ = $_erarry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo htmlentities($type['value']); ?>"><?php echo htmlentities($type['name']); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <ul >
                            <input class="base_text" name="task_type" value="<?php echo htmlentities($_info['task_type']); ?>" readonly/>
                        </ul>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="type" selectedval="<?php echo htmlentities($_info['type']); ?>">
                            <?php if(is_array($resttype) || $resttype instanceof \think\Collection || $resttype instanceof \think\Paginator): $i = 0; $__LIST__ = $resttype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?>
                ...
                <tr>
                    ...
                    <td>
                        <label class="base_label2"><input value="1" type="radio" name="reward_type" <?php echo $_info['reward_type']==1 ? 'checked'  :  ''; ?>/>积分</label>
                        <label class="base_label2"><input value="2" type="radio" name="reward_type" <?php echo $_info['reward_type']==2 ? 'checked'  :  ''; ?>/>金币</label>
                    ...
                    <td>
                        <ul id="content">
                            ...
                            <li class="recharge-item" style="padding-top: 10px">
                                <input style="width: 500px" class="base_text" name="finish" value="<?php echo htmlentities($finish); ?>"/>  ( 多重递进奖励请用','分割)
                            </li>
                ...
                <tr>
                    ...
                    <td>
                        <ul id="content">
                            ...
                            <li class="recharge-item" style="padding-top: 10px">
                                <input style="width: 500px" class="base_text" name="reward" value="<?php echo htmlentities($reward); ?>"/>  ( 多重递进奖励请用','分割)
                ...
                <tr>
                    ...
                    <td>
                        <input readonly placeholder="默认为当前时间" class="base_text" name="release_time"
                               value="<?php echo htmlentities(time_format($_info['create_time'],'','Y-m-d H:i')); ?>"/>
