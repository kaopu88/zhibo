...
<script>
    layui.use(['element', 'layer'], function(){
        ...
        <div class="bg_form">
            <form action="<?php echo url('agent'); ?>">
                    ...
                    <div class="layui-tab-content">
                        ...
                        <div class="layui-tab-item layui-show">
                            <table class="content_info2 mt_10">
                                <tr>
                                    <td class="field_name"><?php echo config('app.agent_setting.agent_name'); ?>管理后台</td>
                                    <td>
                                        <select class="base_select" name="agent_setting[agent_status]" selectedval="<?php echo !empty($_info['agent_setting']['agent_status']) ? '1'  :  '0'; ?>">
                                ...
                                <tr>
                                    <td class="field_name"><?php echo config('app.agent_setting.agent_name'); ?>前台</td>
                                    <td>
                                        <select class="base_select" name="agent_setting[agent_front_status]" selectedval="<?php echo !empty($_info['agent_setting']['agent_front_status']) ? '1'  :  '0'; ?>">
                                            <option value="1">开启</option>
                                            <option value="0">关闭</option>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="agent_setting[agent_name]" value="<?php echo htmlentities($_info['agent_setting']['agent_name']); ?>"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="base_text" name="agent_setting[promoter_name]" value="<?php echo htmlentities($_info['agent_setting']['promoter_name']); ?>"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="agent_setting[close_info]" class="base_text" style="height:120px;"><?php echo htmlentities($_info['agent_setting']['close_info']); ?></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div>
