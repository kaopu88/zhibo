    ...
    <div class="pa_20">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        <input placeholder="用户ID、昵称、手机号" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
        ...
        <div class="table_slide">
            ...
            <tr>
                ...
                <td style="width: 12%">发起用户</td>
                <td style="width: 9%">代邀请人</td>
                <td style="width: 8%">口令</td>
            </tr>
            </thead>
            <tbody>
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                            ...
                            <div class="thumb" style="width: 70%">
                                ...
                                <p class="thumb_info">
                                    <a href="<?php echo url('user/detail',['user_id'=>$vo['user_id']]); ?>">
                                        <?php echo htmlentities(user_name($vo['nickname'])); ?><br/>
                        ...
                        <td>
                            <?php if($vo['friend_id'] > 0): ?>
                                <div class="thumb" style="width: 70%">
                                    <a href="javascript:;" class="thumb_img">
                                        <img src="<?php echo img_url($vo['friend_info']['avatar'],'200_200','logo'); ?>"/>
                                    </a>
                                    <p class="thumb_info">
                                        <a href="javascript:;">
                                            <?php echo htmlentities($vo['friend_info']['nickname']); ?>
                                            <br/>
                                            <?php echo htmlentities((str_hide($vo['friend_info']['phone'],3,4) ?: '未绑定')); ?>
                                        </a>
                                    </p>
                                </div>
                            <?php endif; ?>
