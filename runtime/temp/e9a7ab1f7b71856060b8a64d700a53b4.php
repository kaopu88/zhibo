        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="coin" value="<?php echo htmlentities($_info['coin']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">积分</td>
                    <td>
                        <input class="base_text" name="score" value="<?php echo htmlentities($_info['score']); ?>"/>
                    </td>
                </tr>
                <tr>
