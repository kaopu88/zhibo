<?php /*a:1:{s:59:"/www/wwwroot/zhibb/application/admin/view/account/login.tpl";i:1591090100;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>登录中心-<?php echo APP_NAME; ?>管理中心</title>
    <link rel="stylesheet" href="/bx_static/layui.css">
    <link rel="stylesheet" href="/bx_static/admin/style/admin/css/login.css">
</head>
    ...
    <div class="login_left">
        <div class="login_left_container">
            <div class="bingxin_logo">
                <a href="#">
                    <img src="<?php echo img_url('','200_200','logo');; ?>" alt="">
                </a>
            </div>
            <div class="login_text">
                <p class="login_text_top"><?php echo APP_NAME; ?></p>
                <p class="login_text_top"><?php echo APP_SLOGAN; ?></p>
                <p class="login_text_bottom">
                    —<?php echo APP_NAME; ?>后台管理系统</p>
            </div>
        </div>
    </div>
    <div class="login_main">
        ...
        <div class="contact">
            ...
            <div class="contact_us_img">
                <img src="<?php echo htmlentities($site['qrcode_wx']); ?>" alt="">
            </div>
    ...
    <div class="login_main_app">
        <div class="login_center_app login_welcome">
            <div>
                ...
                <h2 class="welcome"><?php echo APP_NAME; ?>后台管理!</h2>
            </div>
...
<script src="/bx_static/admin/js/login.js"></script>
<script>
