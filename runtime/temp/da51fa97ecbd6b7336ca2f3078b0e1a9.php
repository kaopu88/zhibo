...
<div class="main">
  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('release'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    <td class="field_name">定时时间</td>
                    <td>
                        <input placeholder="请选择时间" class="base_text" name="trigger_time" value="<?php echo htmlentities($_info['trigger_time']); ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="group_id" selectedval="<?php echo htmlentities($_info['group_id']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="directly" selectedval="<?php echo htmlentities($_info['directly']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <label><input checkedval="<?php echo htmlentities($_info['content_type']); ?>" name="content_type" type="radio" value="url">链接</label>
                        <label><input checkedval="<?php echo htmlentities($_info['content_type']); ?>" name="content_type" type="radio" value="text">文本</label>
                    </td>
                </tr>
                <tr class="">
                    <td class="field_name">推送描述</td>
                    <td>
                        <textarea  name="summary" class="base_textarea"><?php echo htmlentities($_info['summary']); ?></textarea>
                    </td>
                </tr>
                <tr class="push_content_text push_content">
                    <td class="field_name">推送文本</td>
                    <td>
                        <textarea style="height: 150px;" name="text" class="base_textarea"><?php echo htmlentities($_info['text']); ?></textarea>
                ...
                <tr class="push_content_url push_content">
                    ...
                    <td>
                        ...
                        视频：<?php echo LOCAL_PROTOCOL_DOMAIN; ?>video_detail?id=10000<br/>
                            直播：<?php echo LOCAL_PROTOCOL_DOMAIN; ?>live_detail?room_id=10000<br/>
                            用户：<?php echo LOCAL_PROTOCOL_DOMAIN; ?>personal?user_id=10000
                        </p>
                    </td>
                </tr>
                <tr>
