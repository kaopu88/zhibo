            ...
            list: [
                {
                    name: 'props_id',
                    title: '道具',
                    get: '<?php echo url("props/get_list"); ?>'
                },
                {
                    name: 'unit',
                    title: '单位',
    ...
    <div class="pa_20">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        <input placeholder="ID" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
                        <button class="filter_search_submit">搜索</button>
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
            <input type="hidden" name="props_id" value="<?php echo input('props_id'); ?>"/>
            <input type="hidden" name="unit" value="<?php echo input('unit'); ?>"/>
        ...
        <div class="table_slide">
            ...
            <tr>
                ...
                <td style="width: 8%;">等值<?php echo APP_BEAN_NAME; ?></td>
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>
                            <div class="thumb">
                                <a rel="thumb" href="<?php echo img_url($vo['cover_icon'],'','thumb'); ?>" class="thumb thumb_img user_base_avatar fancybox" alt="">
                        ...
                        <td><?php echo htmlentities($vo['discount']); ?></td>
                        <td><?php echo htmlentities($vo['length']); ?></td>
                        <td><?php echo htmlentities($vo['unit_str']); ?></td>
                        <td><?php echo htmlentities($vo['conv_millet']); ?></td>
                        <td>
                            <div tgradio-not="<?php echo check_auth('admin:props_bean:update')?'0':'1'; ?>" tgradio-on="1"
                                 tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['status']); ?>"
                                 tgradio-name="status"
                                 tgradio="<?php echo url('props_bean/change_status',['id'=>$vo['id']]); ?>"></div>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['create_time'],'无','date')); ?>
                        </td>
                        <td>
                            <?php if(check_auth('admin:props_bean:update',AUTH_UID)): ?>
