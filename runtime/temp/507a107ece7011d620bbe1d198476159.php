...
<head lang="en">
    ...
    <script src="<?php echo ('/static/'.strtolower(\think\facade\Request::module()).'/js'); ?>/ad_content/add.js?v=<?php echo config('upload.resource_version'); ?>"></script>
...
<div class="main">
  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <form action="<?php echo isset($_info['id'])?url('edit'):url('add'); ?>">
            <table class="content_info2 mt_10">
                <tr>
                    <td class="field_name">所属广告位</td>
                    <td>
                        <select name="space_id" class="base_select" selectedval="<?php echo htmlentities($_info['space_id']); ?>">
                            <option value="">请选择</option>
                            <?php if(is_array($spaces) || $spaces instanceof \think\Collection || $spaces instanceof \think\Paginator): $i = 0; $__LIST__ = $spaces;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$space): $mod = ($i % 2 );++$i;?>
                                <option data-img="<?php echo htmlentities($space['img_config']); ?>" data-platform="<?php echo htmlentities($space['platform']); ?>"
                                        value="<?php echo htmlentities($space['id']); ?>"><?php echo htmlentities($space['name']); ?>
                                </option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input name="image" type="hidden" value="<?php echo htmlentities($_info['image']); ?>"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="video" value="<?php echo htmlentities($_info['video']); ?>" type="text"
                ...
                <tr>
                    ...
                    <td>
                        <div class="base_group">
                            <input style="width: 309px;" name="url" value="<?php echo htmlentities($_info['url']); ?>" type="text" class="base_text border_left_radius"/>
                    ...
                    <td>
                        <div class="base_row">
                            <input readonly placeholder="开始时间" style="width: 45%;float: left;" name="start_time"
                                   value="<?php echo htmlentities(time_format($_info['start_time'],'','Y-m-d H:i')); ?>"
                                   type="text" class="base_text"/>
                            <input readonly placeholder="结束时间" style="width: 45%;float: right" name="end_time"
                                   value="<?php echo htmlentities(time_format($_info['end_time'],'','Y-m-d H:i')); ?>"
                                   type="text" class="base_text"/>
                            <div class="clear"></div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" value="<?php echo htmlentities($_info['os']); ?>" class="os_val"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="base_row">
                            <input placeholder="开始版本" style="width: 45%;float: left;" name="code_min"
                                   value="<?php echo htmlentities((isset($_info['code_min']) && ($_info['code_min'] !== '')?$_info['code_min']:0)); ?>"
                                   type="text" class="base_text"/>
                            <input placeholder="结束版本" style="width: 45%;float: right" name="code_max"
                                   value="<?php echo htmlentities((isset($_info['code_max']) && ($_info['code_max'] !== '')?$_info['code_max']:1000)); ?>"
                                   type="text" class="base_text"/>
                            <div class="clear"></div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <label class="base_label2">
                            <input checkedval="<?php echo htmlentities($_info['purview_login']); ?>" name="purview_login" value="" type="radio"
                                   style="margin-right: 5px"/>不限
                        </label>
                        <label class="base_label2">
                            <input checkedval="<?php echo htmlentities($_info['purview_login']); ?>" name="purview_login" value="login" type="radio"
                                   style="margin-right: 5px"/>登录可见
                        </label>
                        <label class="base_label2">
                            <input checkedval="<?php echo htmlentities($_info['purview_login']); ?>" name="purview_login" value="not_login"
                                   type="radio" style="margin-right: 5px"/>未登录可见
                        </label>
                        <br/>
                        <label class="base_label2">
                            <input checkedval="<?php echo htmlentities($_info['purview_vip']); ?>" name="purview_vip" value="" type="radio"
                                   style="margin-right: 5px"/>不限
                        </label>
                        <label class="base_label2">
                            <input checkedval="<?php echo htmlentities($_info['purview_vip']); ?>" name="purview_vip" value="vip" type="radio"
                                   style="margin-right: 5px"/>会员可见
                        </label>
                        <label class="base_label2">
                            <input checkedval="<?php echo htmlentities($_info['purview_vip']); ?>" name="purview_vip" value="not_vip" type="radio"
                ...
                <tr>
                    ...
                    <td>
                        <input class="base_text" name="sort" value="<?php echo htmlentities($_info['sort']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td class="field_name">允许关闭</td>
                    <td>
                        <select class="base_select" name="allow_close" selectedval="<?php echo htmlentities($_info['allow_close']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select class="base_select" name="status" selectedval="<?php echo htmlentities($_info['status']); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <?php if(isset($_info['id'])): ?>
                            <input name="id" type="hidden" value="<?php echo htmlentities($_info['id']); ?>"/>
                        <?php endif; ?>
                        <?php echo '<input type="hidden" name="redirect" value="'.input('redirect').'" />'; ?>
