  ...
  <div class="sub_catalog"></div>
    ...
    <div class="pa_20">
        ...
        <div class="filter_box mt_10">
            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    <div class="filter_search">
                        <input placeholder="用户ID、姓名、卡名" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
            ...
            <input type="hidden" name="verify_status" value="<?php echo htmlentities($get['verify_status']); ?>"/>
        </div>
    ...
    <p class="thumb_info">
        <a href="<?php echo url('user/detail',['user_id'=>$vo['user']['user_id']]); ?>">
            ...
            <?php echo htmlentities((str_hide($vo['user']['phone'],3,4) ?: '未绑定')); ?>
                        ...
                        <td><?php echo htmlentities($vo['card_name']); ?></td>
                        <td><?php echo htmlentities($vo['account']); ?></td>
                        <td><?php echo htmlentities($vo['verify_status_str']); ?></td>
                        <td>
                            <?php echo htmlentities(time_format($vo['create_time'])); ?>
                        </td>
                        <td>
                            <?php echo htmlentities(time_format($vo['delete_time'])); ?>
                        </td>
                    </tr>
