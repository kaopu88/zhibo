        ...
        <div class="content_toolbar mt_10">
            <div class="content_toolbar_search">
                <div class="base_group">
                    ...
                    <input name="keyword" class="base_text base_text_s finder" style="width:180px;" value="<?php echo input('keyword'); ?>" placeholder="搜索手机号、姓名、用户ID"/>
        ...
        <table class="content_list mt_10 table_fixed">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td><?php echo htmlentities($vo['card_num']); ?></td>
                        <td>
                            <div class="thumb">
                        ...
                        <td><?php echo htmlentities(time_format($vo['create_time'],'','Y-m-d H:i:s')); ?></td>
                        <td>
                            <?php if(vo.open_fee != 0): ?>
                                <?php echo htmlentities($vo['open_fee']); endif; ?>
                        </td>
                        <td>
                            <?php if(vo.open_fee != 0): switch($vo['pay_status']): case "0": ?>
                                        未支付
                                    <?php break; case "1": ?>
                                        已支付
                                    <?php break; endswitch; endif; ?>
                        </td>
                        <td><?php echo htmlentities($vo['pay_order']); ?></td>
                        <td>
                            <?php switch($vo['status']): case "0": if(check_auth('taoke:audit:update',AUTH_UID)): ?>
                                        <a layer-area="700px,400px" layer-open="<?php echo url('audit/audit', array("id"=>$vo['id'])); ?>">
                                            审核
                                        </a>
                        ...
                        <td><?php echo htmlentities(time_format($vo['check_time'],'','Y-m-d H:i:s')); ?></td>
                    </tr>
