            ...
            <div class="filter_options">
                ...
                <div class="filter_order">
                    ...
                    <div class="filter_search">
                        <input placeholder="标题或作者" type="text" name="keyword" value="<?php echo input('keyword'); ?>"/>
        ...
        <div class="table_slide">
            <table class="content_list mt_10 table_fixed" >
                ...
                <tr>
                    ...
                    <td style="width: 10%;">首段歌词</td>
                    <td style="width: 6%;">发布时间</td>
                    <td style="width: 8%;">热搜状态</td>
                        ...
                        <tr data-id="<?php echo htmlentities($vo['id']); ?>">
                            ...
                            <td>
                                <div class="thumb">
                                    ...
                                    <p class="thumb_info">
                                        <?php echo htmlentities(short($vo['title'],'20')); ?>
                                    </p>
                                </div>
                            </td>
                            <td>
                                <?php echo htmlentities(short($vo['author'],'20')); ?>
                            </td>
                            <td>
                                    <?php echo htmlentities(short($vo['classfiy'],'20')); ?>
                            </td>
                            <td>
                                <?php if(!(empty($vo['lyricsarray']) || (($vo['lyricsarray'] instanceof \think\Collection || $vo['lyricsarray'] instanceof \think\Paginator ) && $vo['lyricsarray']->isEmpty()))): ?>
                                    <?php echo htmlentities(short($vo['lyricsarray'][0],'20')); endif; ?>
                            </td>
                            ...
                            <td>
                                <div tgradio-not="<?php echo check_auth('friend:Lyrics:change_hot')?'0':'1'; ?>" tgradio-on="1"
                                     tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['is_hot']); ?>"
                                     tgradio-name="ishot" tgradio-on-name="热搜" tgradio-off-name="普通"
                                     tgradio="<?php echo url('Lyrics/change_hot',['id'=>$vo['id']]); ?>"></div>
                            </td>

                            <td>
                                <div tgradio-not="<?php echo check_auth('friend:Lyrics:change_status')?'0':'1'; ?>" tgradio-on="1"
                                    tgradio-off="0" tgradio-value="<?php echo htmlentities($vo['status']); ?>"
                                    tgradio-name="status" tgradio-on-name="启用" tgradio-off-name="关闭"
                                    tgradio="<?php echo url('Lyrics/change_status',['id'=>$vo['id']]); ?>"></div>
                            </td>
                            <td>
